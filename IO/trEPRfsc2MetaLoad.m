...
try
    ...
    for k=1:length(block.calibrationData)
        ...
        if strfind(block.parameters.calibration,'field');
            ...
            data{k}.parameters.field.calibration = [...
        ...
        if strfind(block.parameters.calibration,'frequency');
            ...
            data{k}.parameters.bridge.calibration = [...
                frequencyStart{1} frequencyEnd{1} ...
                ];
        end
        % TODO: Assign required (and additional) parameters from COMMENT
        % block (needs changes in the COMMENT block structure)
    end
