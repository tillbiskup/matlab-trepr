...
uicontrol('Tag','internal_panel_description',...
    ...
    'String',{'Setting GUI internals such as directories and log levels; make snapshots, ...'}...
    );
...
handle_p3 = uipanel('Tag','internal_panel_snapshot_panel',...
    ...
    'FontUnit','Pixel','Fontsize',12,...
    'Units','Pixels',...
    'Position',[10 handle_size(4)-365 handle_size(3)-20 130],...
    'Title','Snapshots'...
    );
uicontrol('Tag','internal_panel_snapshot_description',...
    ...
    'HorizontalAlignment','Left',...
    'FontAngle','oblique',...
    'Position',[10 75 handle_size(3)-70 30],...
...
uicontrol('Tag','internal_panel_snapshot_help_pushbutton',...
    ...
    'Position',[handle_size(3)-55 85 25 25],...
    'Enable','on',...
    'Callback',{@pushbutton_Callback,'snapshotHelp'}...
    );
uicontrol('Tag','internal_panel_snapshot_save_edit',...
    'Style','edit',...
    'Parent',handle_p3,...
    'BackgroundColor',[1 1 1],...
    'FontUnit','Pixel','Fontsize',12,...
    'Units','Pixels',...
    'Position',[10 42 handle_size(3)-110 25],...
    'HorizontalAlign','Left',...
    'String',[datestr(now,30) '.mat'],...
    'TooltipString',sprintf('%s\n%s',...
    'File to save current state of the trEPR GUI as snapshot to.',...
    'Click to get file selection dialogue window.'),...
    'Enable','inactive',...
    'ButtonDownFcn',{@buttondown_Callback,'snapshotSave'},...
    'Callback',{@edit_Callback,'snapshotSave'}...
    );
uicontrol('Tag','internal_panel_snapshot_save_pushbutton',...
    ...
    'String','Save',...
    'TooltipString',sprintf('%s\n%s',...
    'Save current state of the trEPR GUI as snapshot',...
    'to the file given in the left edit field'),...
    'Callback',{@pushbutton_Callback,'snapshotSave'}...
    );
uicontrol('Tag','internal_panel_snapshot_load_edit',...
    'Style','edit',...
    'Parent',handle_p3,...
    'BackgroundColor',[1 1 1],...
    'FontUnit','Pixel','Fontsize',12,...
    'Units','Pixels',...
    'Position',[10 12 handle_size(3)-110 25],...
    'HorizontalAlign','Left',...
    'String','',...
    'TooltipString',sprintf('%s\n%s',...
    'File to load current state of the trEPR GUI as snapshot from.',...
    'Click to get file selection dialogue window.'),...
    'Enable','inactive',...
    'ButtonDownFcn',{@buttondown_Callback,'snapshotLoad'},...
    'Callback',{@edit_Callback,'snapshotLoad'}...
    );
uicontrol('Tag','internal_panel_snapshot_load_pushbutton',...
    ...
    'String','Load',...
    'TooltipString',sprintf('%s\n%s',...
    'Load saved state of the trEPR GUI as snapshot',...
    'from the file given in the left edit field'),...
...
handle_p4 = uipanel('Tag','internal_panel_cmd_panel',...
    ...
    'FontUnit','Pixel','Fontsize',12,...
    'Units','Pixels',...
    'Position',[10 handle_size(4)-470 handle_size(3)-20 95],...
...
function buttondown_Callback(~,~,action)
    try
        if isempty(action)
            return;
        end
        ...
        switch lower(action)
            case 'snapshotsave'
                ...
                % Set filename in edit field
                set(gh.internal_panel_snapshot_save_edit,'String',fileName);
            case 'snapshotload'
                ...
                ad.control.dirs.lastSnapshot = pathName;
                % Set filename in edit field
                set(gh.internal_panel_snapshot_load_edit,'String',fileName);
            otherwise
                st = dbstack;
                trEPRmsg(...
                    [st.name ' : unknown action "' action '"'],...
