...
% Drift GUI.
%
% Normally, this window is called from within the trEPRgui_MWfrequencyDrift
% window. 
%
...
% Try to get MWfrequencyDriftwindow GUI position
...
hMainFigure = figure('Tag',mfilename,...
    'Visible','off',...
    'Name','trEPR GUI : MW Frequency Drift Analysis : Help Window',...
    'Units','Pixels',...
...
uicontrol('Tag','heading_text',...
    ...
    'String','How to Use the MW Frequency Drift Analysis GUI?'...
    );
...
uicontrol('Tag','helptopic_popupmenu',...
    ...
    'String','Introduction|Analysis|Display|Settings|Key bindings',...
    'KeyPressFcn',@keypress_Callback,...
    ...
    try
        ...
        switch helpText
            ...
            case 'Analysis'
                % Read text from file and display it
                helpTextFile = fullfile(trEPRinfo('dir'),...
                    'GUI','private','helptexts','MWfrequencyDrift','analysis.html');
                browser.setCurrentLocation(helpTextFile);
            case 'Display'
                % Read text from file and display it
                helpTextFile = fullfile(trEPRinfo('dir'),...
                    'GUI','private','helptexts','MWfrequencyDrift','display.html');
                browser.setCurrentLocation(helpTextFile);
            case 'Settings'
                % Read text from file and display it
                helpTextFile = fullfile(trEPRinfo('dir'),...
                    'GUI','private','helptexts','MWfrequencyDrift','settings.html');
                browser.setCurrentLocation(helpTextFile);
            case 'Key bindings'
                % Read text from file and display it
                helpTextFile = fullfile(trEPRinfo('dir'),...
                    'GUI','private','helptexts','MWfrequencyDrift','keybindings.html');
                browser.setCurrentLocation(helpTextFile);
            otherwise
