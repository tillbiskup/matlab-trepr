...
% Drift GUI.
%
% Normally, this window is called from within the trEPRgui_NetPolarisation
% window. 
%
...
uicontrol('Tag','heading_text',...
    ...
    'String','How to Use the Net Polarisation Analysis GUI?'...
    );
    ...
    try
        ...
        switch helpText
            ...
            case 'Analysis'
                % Read text from file and display it
                helpTextFile = fullfile(trEPRinfo('dir'),...
                    'GUI','private','helptexts','NetPolarisation','analysis.html');
                browser.setCurrentLocation(helpTextFile);
            case 'Display'
                % Read text from file and display it
                helpTextFile = fullfile(trEPRinfo('dir'),...
                    'GUI','private','helptexts','NetPolarisation','display.html');
                browser.setCurrentLocation(helpTextFile);
            case 'Settings'
                % Read text from file and display it
                helpTextFile = fullfile(trEPRinfo('dir'),...
                    'GUI','private','helptexts','NetPolarisation','settings.html');
                browser.setCurrentLocation(helpTextFile);
            case 'Key bindings'
                % Read text from file and display it
                helpTextFile = fullfile(trEPRinfo('dir'),...
                    'GUI','private','helptexts','NetPolarisation','keybindings.html');
                browser.setCurrentLocation(helpTextFile);
            otherwise
