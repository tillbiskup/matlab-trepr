function [status,warnings] = cmdHistory(handle,varargin)
% CMDHISTORY Command line command of the trEPR GUI.
%
% Usage:
%   cmdHistory(handle,opt)
%   [status,warnings] = cmdHistory(handle,opt)
%
%   handle  - handle
