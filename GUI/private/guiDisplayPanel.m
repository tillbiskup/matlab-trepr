...
uicontrol('Tag','display_panel_axesexport_filetype_popupmenu',...
    ...
    'FontUnit','Pixel','Fontsize',12,...
    'Units','Pixels',...
    'Position',[handle_size(3)-160 15 70 20],...
...
handle_p8 = uipanel('Tag','display_panel_3Ddisplay_panel',...
    'Parent',handle_pp3,...
    'BackgroundColor',defaultBackground,...
    'FontUnit','Pixel','Fontsize',12,...
    'Units','Pixels',...
    'Position',[0 handle_size(4)-440 handle_size(3)-20 220],...
    'Title','3D display'...
    );
...
handle_p9 = uipanel('Tag','display_panel_dataexport_panel',...
    'Parent',handle_pp4,...
    'BackgroundColor',defaultBackground,...
    'FontUnit','Pixel','Fontsize',12,...
    'Units','Pixels',...
    'Position',[0 handle_size(4)-250 handle_size(3)-20 130],...
...
uicontrol('Tag','display_panel_dataexport_filetype_popupmenu',...
    ...
    'FontUnit','Pixel','Fontsize',12,...
    'Units','Pixels',...
    'Position',[handle_size(3)-170 15 80 20],...
    'String','ASCII',...
    'TooltipString','Select type of graphics file (fig means "detach")'...
    );
