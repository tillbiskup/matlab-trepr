...
handle_pp4_1 = uipanel('Tag','display_panel_axesexport_panel',...
    ...
    'FontUnit','Pixel','Fontsize',12,...
    'Units','Pixels',...
    'Position',[0 handle_size(4)-200 handle_size(3)-20 120],...
    'Title','Export figure'...
    );
...
handle_pp4_2 = uipanel('Tag','display_panel_dataexport_panel',...
    ...
    'FontUnit','Pixel','Fontsize',12,...
    'Units','Pixels',...
    'Position',[0 handle_size(4)-400 handle_size(3)-20 190],...
        ...
        switch action
            ...
            case 'markerSize'
                ad.data{active}.line.marker.size = ...
                    str2double(strrep(get(source,'String'),',','.'));
            otherwise
                disp(['trEPRgui_MFEwindow() : edit_Callback() : '...
                    'Unknown action "' action '"']);
                return;
        end
        setappdata(mainWindow,'control',ad.control);
    ...
    try
        ...
        switch action
            ...
            case 'markerDefaults'
                ...
                return;                
            otherwise
                disp(['trEPRgui : guiDisplayPanel() : pushbutton_Callback(): '...
                    'Unknown action "' action '"']);
                return;
        end
    catch exception
