function handle = panelDisplay(parentHandle,position)
% PANELDISPLAY Add a panel for display settings to a gui
...
uicontrol('Tag','display_panel_page1_pushbutton',...
    ...
    'FontUnit','Pixel','Fontsize',12,...
    'String','1',...
    'TooltipString','Page 1: Axis settings',...
...
uicontrol('Tag','display_panel_page2_pushbutton',...
    ...
    'FontUnit','Pixel','Fontsize',12,...
    'String','2',...
    'TooltipString','Page 2: Grid, zero line, legend, 2D display settings',...
...
uicontrol('Tag','display_panel_page3_pushbutton',...
    ...
    'FontUnit','Pixel','Fontsize',12,...
    'String','3',...
    'TooltipString','Page 3: Normalisation, highlighting, display of additional features',...
...
uicontrol('Tag','display_panel_page4_pushbutton',...
    ...
    'FontUnit','Pixel','Fontsize',12,...
    'String','4',...
    'TooltipString','Page 4: Projection, and residuals axes, g axis',...
...
uicontrol('Tag','display_panel_page5_pushbutton',...
    ...
    'FontUnit','Pixel','Fontsize',12,...
    'String','5',...
    'TooltipString','Page 5: Line settings of currently active dataset',...
...
uicontrol('Tag','display_panel_page6_pushbutton',...
    ...
    'FontUnit','Pixel','Fontsize',12,...
    'String','6',...
    'TooltipString','Page 6: 3D display and export',...
...
uicontrol('Tag','display_panel_page7_pushbutton',...
    ...
    'FontUnit','Pixel','Fontsize',12,...
    'String','7',...
    'TooltipString','Page 7: Export figure',...
...
handle_pp1_1 = uipanel('Tag','display_panel_axislabels_panel',...
    ...
    'FontUnit','Pixel','Fontsize',12,...
    'Units','Pixels',...
    'Position',[0 handle_size(4)-240 handle_size(3)-20 160],...
    'Title','Axis labels'...
    );
uicontrol('Tag','display_panel_axislabels_measure_text',...
    ...
    'FontUnit','Pixel','Fontsize',12,...
    'Units','Pixels',...
    'Position',[60 115 (handle_size(3)-90)/3*2 25],...
    'String','Measure'...
    );
uicontrol('Tag','display_panel_axislabels_unit_text',...
    ...
    'FontUnit','Pixel','Fontsize',12,...
    'Units','Pixels',...
    'Position',[60+(handle_size(3)-90)/3*2 115 (handle_size(3)-90)/3 25],...
    'String','Unit'...
    );
...
uicontrol('Tag','display_panel_axislabels_x_measure_edit',...
    ...
    'FontUnit','Pixel','Fontsize',12,...
    'Units','Pixels',...
    'Position',[60 95 (handle_size(3)-90)/3*2 25],...
    'String','index',...
...
uicontrol('Tag','display_panel_axislabels_x_unit_edit',...
    ...
    'FontUnit','Pixel','Fontsize',12,...
    'Units','Pixels',...
    'Position',[60+(handle_size(3)-90)/3*2 95 (handle_size(3)-90)/3 25],...
    'String','points',...
...
uicontrol('Tag','display_panel_axislabels_y_measure_edit',...
    ...
    'FontUnit','Pixel','Fontsize',12,...
    'Units','Pixels',...
    'Position',[60 70 (handle_size(3)-90)/3*2 25],...
    'String','index',...
...
uicontrol('Tag','display_panel_axislabels_y_unit_edit',...
    ...
    'FontUnit','Pixel','Fontsize',12,...
    'Units','Pixels',...
    'Position',[60+(handle_size(3)-90)/3*2 70 (handle_size(3)-90)/3 25],...
    'String','points',...
...
uicontrol('Tag','display_panel_axislabels_z_measure_edit',...
    ...
    'FontUnit','Pixel','Fontsize',12,...
    'Units','Pixels',...
    'Position',[60 45 (handle_size(3)-90)/3*2 25],...
    'String','index',...
...
uicontrol('Tag','display_panel_axislabels_z_unit_edit',...
    ...
    'FontUnit','Pixel','Fontsize',12,...
    'Units','Pixels',...
    'Position',[60+(handle_size(3)-90)/3*2 45 (handle_size(3)-90)/3 25],...
    'String','points',...
...
handle_pp1_2 = uipanel('Tag','display_panel_axislimits_panel',...
    ...
    'FontUnit','Pixel','Fontsize',12,...
    'Units','Pixels',...
    'Position',[0 handle_size(4)-400 handle_size(3)-20 150],...
    'Title','Axis limits'...
    );
uicontrol('Tag','display_panel_axislimits_min_text',...
    ...
    'FontUnit','Pixel','Fontsize',12,...
    'Units','Pixels',...
    'Position',[60 105 (handle_size(3)-90)/2 25],...
    'String','min'...
    );
uicontrol('Tag','display_panel_axislimits_max_text',...
    ...
    'FontUnit','Pixel','Fontsize',12,...
    'Units','Pixels',...
    'Position',[60+(handle_size(3)-90)/2 105 (handle_size(3)-90)/2 25],...
    'String','max'...
    );
...
handle_pp1_3 = uipanel('Tag','display_panel_axisshow_panel',...
    'Parent',handle_pp1,...
    'BackgroundColor',defaultBackground,...
    'FontUnit','Pixel','Fontsize',12,...
    'Units','Pixels',...
    'Position',[0 handle_size(4)-480 handle_size(3)-20 70],...
    'Title','Axis display'...
    );
uicontrol('Tag','display_panel_axisshow_yaxis_checkbox',...
    'Style','checkbox',...
    'Parent',handle_pp1_3,...
    'BackgroundColor',defaultBackground,...
    'FontUnit','Pixel','Fontsize',12,...
    'Units','Pixels',...
    'Position',[10 30 (handle_size(3)-20)/2-20 20],...
    'String',' YAxis',...
    'TooltipString',sprintf('%s\n%s','Toggle between displaying y axis.',...
    '(In 1D display mode, often the y axis is of no particular meaning)'),...
    'Value',1,...
    'Callback',{@checkbox_Callback,'showyaxis'}...
    );
uicontrol('Tag','display_panel_axisshow_yticks_checkbox',...
    'Style','checkbox',...
    'Parent',handle_pp1_3,...
    'BackgroundColor',defaultBackground,...
    'FontUnit','Pixel','Fontsize',12,...
    'Units','Pixels',...
    'Position',[(handle_size(3)-20)/2 30 (handle_size(3)-20)/2-20 20],...
    'String',' YTicks',...
    'TooltipString',sprintf('%s\n%s','Toggle between displaying y ticks.',...
    '(In 1D display mode, often the y axis is of no particular meaning)'),...
    'Value',1,...
    'Callback',{@checkbox_Callback,'showyticks'}...
    );
uicontrol('Tag','display_panel_axisshow_title_checkbox',...
    'Style','checkbox',...
    'Parent',handle_pp1_3,...
    'BackgroundColor',defaultBackground,...
    'FontUnit','Pixel','Fontsize',12,...
    'Units','Pixels',...
    'Position',[10 10 (handle_size(3)-20)/2-20 20],...
    'String',' Title',...
    'TooltipString',sprintf('%s\n%s','Toggle between displaying title.',...
    '(The label of the currently active dataset would be used as title.)'),...
    'Value',1,...
    'Callback',{@checkbox_Callback,'showtitle'}...
    );
uicontrol('Tag','display_panel_axisshow_box_checkbox',...
    'Style','checkbox',...
    'Parent',handle_pp1_3,...
    'BackgroundColor',defaultBackground,...
    'FontUnit','Pixel','Fontsize',12,...
    'Units','Pixels',...
    'Position',[(handle_size(3)-20)/2 10 (handle_size(3)-20)/2-20 20],...
    'String',' Box',...
    'TooltipString',sprintf('%s\n%s','Toggle between displaying a box.',...
    '(A box surrounding a plot is a matter of taste...)'),...
    'Value',1,...
    'Callback',{@checkbox_Callback,'showbox'}...
    );
...
uicontrol('Tag','display_panel_zerolinewidthunit_text',...
    'Style','text',...
    'Parent',handle_p22_2,...
    'BackgroundColor',defaultBackground,...
    'FontUnit','Pixel','Fontsize',12,...
...
handle_pp2_3 = uipanel('Tag','display_panel_legend_panel',...
    ...
    'FontUnit','Pixel','Fontsize',12,...
    'Units','Pixels',...
    'Position',[0 handle_size(4)-385 handle_size(3)-20 95],...
    'Title','Legend'...
    );
uicontrol('Tag','display_panel_legend_auto_togglebutton',...
    ...
    'pos',[10 45 (handle_size(3)-40)/5 30],...
    'parent',handle_pp2_3,...
    'HandleVisibility','off',...
    'Value',0,...
...
uicontrol('Tag','display_panel_legend_nw_togglebutton',...
    ...
    'pos',[handle_size(3)-30-(((handle_size(3)-50)/5)*4) 45 (handle_size(3)-50)/5 30],...
    'parent',handle_pp2_3,...
    'HandleVisibility','off',...
    'Value',0,...
    'Callback',{@grid_legend_togglebutton_Callback}...
...
uicontrol('Tag','display_panel_legend_ne_togglebutton',...
    ...
    'pos',[handle_size(3)-30-(((handle_size(3)-50)/5)*3) 45 (handle_size(3)-50)/5 30],...
    'parent',handle_pp2_3,...
    'HandleVisibility','off',...
    'Value',0,...
    'Callback',{@grid_legend_togglebutton_Callback}...
...
uicontrol('Tag','display_panel_legend_sw_togglebutton',...
    ...
    'pos',[handle_size(3)-30-(((handle_size(3)-50)/5)*2) 45 (handle_size(3)-50)/5 30],...
    'parent',handle_pp2_3,...
    'HandleVisibility','off',...
    'Value',0,...
    'Callback',{@grid_legend_togglebutton_Callback}...
...
uicontrol('Tag','display_panel_legend_se_togglebutton',...
    ...
    'pos',[handle_size(3)-30-(((handle_size(3)-50)/5)) 45 (handle_size(3)-50)/5 30],...
    'parent',handle_pp2_3,...
    'HandleVisibility','off',...
    'Value',0,...
    'Callback',{@grid_legend_togglebutton_Callback}...
...
uicontrol('Tag','display_panel_legendfont_pushbutton',...
    'Style','pushbutton',...
    'Parent',handle_pp2_3,...
    'BackgroundColor',defaultBackground,...
    'Enable','on',...
    'FontUnit','Pixel','Fontsize',12,...
    'Units','Pixels',...
    'Position',[100 10 handle_size(3)-130 30],...
    'String','Font settings...',...
    'TooltipString',sprintf('%s\n%s',...
    'Open Matlab(r) font selection window','to select legend font.'),...
    'Callback',{@pushbutton_Callback,'legendFont'}...
    );

handle_pp2_4 = uipanel('Tag','display_panel_2Ddisplay_panel',...
    'Parent',handle_pp2,...
    'BackgroundColor',defaultBackground,...
    'FontUnit','Pixel','Fontsize',12,...
    'Units','Pixels',...
    'Position',[0 handle_size(4)-465 handle_size(3)-20 70],...
...
handle_pp3_1 = uipanel('Tag','display_panel_normalise_panel',...
    'Parent',handle_pp3,...
    'BackgroundColor',defaultBackground,...
    'FontUnit','Pixel','Fontsize',12,...
    'Units','Pixels',...
...
handle_pp3_2 = uipanel('Tag','display_panel_highlight_panel',...
    'Parent',handle_pp3,...
    'BackgroundColor',defaultBackground,...
    'FontUnit','Pixel','Fontsize',12,...
    'Units','Pixels',...
...
handle_pp3_3 = uipanel('Tag','display_panel_special_display_panel',...
    'Parent',handle_pp3,...
    'BackgroundColor',defaultBackground,...
    'FontUnit','Pixel','Fontsize',12,...
    'Units','Pixels',...
...
handle_pp4_1 = uipanel('Tag','display_panel_projectionaxes_panel',...
    'Parent',handle_pp4,...
    'BackgroundColor',defaultBackground,...
    'FontUnit','Pixel','Fontsize',12,...
    'Units','Pixels',...
    'Position',[0 handle_size(4)-230 handle_size(3)-20 150],...
    'Title','Projection axes'...
    );
uicontrol('Tag','display_panel_projectionaxes_checkbox',...
    'Style','checkbox',...
    'Parent',handle_pp4_1,...
    'BackgroundColor',defaultBackground,...
    'FontUnit','Pixel','Fontsize',12,...
    'Units','Pixels',...
    'Position',[80 105 handle_size(3)-110 20],...
    'String',' Projection axes',...
    'TooltipString','Toggle between displaying projection axes',...
    'Value',0,...
    'Callback',{@checkbox_Callback,'projectionaxes'}...
    );
uicontrol('Tag','display_panel_projectionaxes_method_text',...
    'Style','text',...
    'Parent',handle_pp4_1,...
    'BackgroundColor',defaultBackground,...
    'FontUnit','Pixel','Fontsize',12,...
...
uicontrol('Tag','display_panel_projectionaxes_method_popupmenu',...
    'Style','popupmenu',...
    'Parent',handle_pp4_1,...
    'BackgroundColor',defaultBackground,...
    'FontUnit','Pixel','Fontsize',12,...
    'Units','Pixels',...
    'Position',[80 75 handle_size(3)-105 20],...
    'String','slice|sum',...
    'TooltipString','Choose a display method for the projection axes',...
    'Callback',{@popupmenu_Callback,'projectionaxesmode'}...
    );
uicontrol('Tag','display_panel_projectionaxes_hheight_text',...
    'Style','text',...
    'Parent',handle_pp4_1,...
    'BackgroundColor',defaultBackground,...
    'FontUnit','Pixel','Fontsize',12,...
    ...
    'String','Horizontal axis height'...
    );
uicontrol('Tag','display_panel_projectionaxes_hheight_edit',...
    'Style','edit',...
    'Parent',handle_pp4_1,...
    'BackgroundColor',[1 1 1],...
    'FontUnit','Pixel','Fontsize',12,...
    'Units','Pixels',...
    'Position',[160 40 (handle_size(3)-190) 25],...
    'String','50',...
    'TooltipString','Height of the horizontal projection axis in pixels',...
    'Callback',{@edit_Callback,'projectionaxeshheight'}...
    );
uicontrol('Tag','display_panel_projectionaxes_vheight_text',...
    'Style','text',...
    'Parent',handle_pp4_1,...
    'BackgroundColor',defaultBackground,...
    'FontUnit','Pixel','Fontsize',12,...
    ...
    'String','Vertical axis height'...
    );
uicontrol('Tag','display_panel_projectionaxes_vheight_edit',...
    'Style','edit',...
    'Parent',handle_pp4_1,...
    'BackgroundColor',[1 1 1],...
    'FontUnit','Pixel','Fontsize',12,...
    'Units','Pixels',...
    'Position',[160 10 (handle_size(3)-190) 25],...
    'String','50',...
    'TooltipString','Height of the vertical projection axis in pixels',...
    'Callback',{@edit_Callback,'projectionaxesvheight'}...
    );

handle_pp4_2 = uipanel('Tag','display_panel_residualsaxis_panel',...
    'Parent',handle_pp4,...
    'BackgroundColor',defaultBackground,...
    'FontUnit','Pixel','Fontsize',12,...
    'Units','Pixels',...
    'Position',[0 handle_size(4)-390 handle_size(3)-20 150],...
    'Title','Residuals axis'...
    );
uicontrol('Tag','display_panel_residualsaxis_checkbox',...
    'Style','checkbox',...
    'Parent',handle_pp4_2,...
    'BackgroundColor',defaultBackground,...
    'FontUnit','Pixel','Fontsize',12,...
    'Units','Pixels',...
    'Position',[80 105 handle_size(3)-110 20],...
    'String',' Residuals axis',...
    'TooltipString','Toggle between displaying residuals axis',...
    'Value',0,...
    'Callback',{@checkbox_Callback,'residualsaxis'}...
    );
uicontrol('Tag','display_panel_residualsaxis_method_text',...
    'Style','text',...
    'Parent',handle_pp4_2,...
    'BackgroundColor',defaultBackground,...
    'FontUnit','Pixel','Fontsize',12,...
...
uicontrol('Tag','display_panel_residualsaxis_method_popupmenu',...
    'Style','popupmenu',...
    'Parent',handle_pp4_2,...
    'BackgroundColor',defaultBackground,...
    'FontUnit','Pixel','Fontsize',12,...
    ...
    'Position',[80 75 handle_size(3)-105 20],...
    'String','residuals',...
    'TooltipString','Choose a display method for the residuals axis',...
    'Callback',{@popupmenu_Callback,'residualsaxismode'}...
    );
uicontrol('Tag','display_panel_residualsaxis_height_text',...
    'Style','text',...
    'Parent',handle_pp4_2,...
    'BackgroundColor',defaultBackground,...
    'FontUnit','Pixel','Fontsize',12,...
    ...
    'HorizontalAlignment','Left',...
    'Position',[10 40 140 20],...
    'String','Residuals axis height'...
    );
uicontrol('Tag','display_panel_residualsaxis_height_edit',...
    'Style','edit',...
    'Parent',handle_pp4_2,...
    'BackgroundColor',[1 1 1],...
    'FontUnit','Pixel','Fontsize',12,...
    ...
    'Position',[160 40 (handle_size(3)-190) 25],...
    'String','50',...
    'TooltipString','Height of the residuals axis in pixels',...
    'Callback',{@edit_Callback,'residualsaxisheight'}...
    );
uicontrol('Tag','display_panel_residualsaxis_gap_text',...
    'Style','text',...
    'Parent',handle_pp4_2,...
    'BackgroundColor',defaultBackground,...
    'FontUnit','Pixel','Fontsize',12,...
...
uicontrol('Tag','display_panel_residualsaxis_gap_edit',...
    'Style','edit',...
    'Parent',handle_pp4_2,...
    'BackgroundColor',[1 1 1],...
    'FontUnit','Pixel','Fontsize',12,...
    ...
    'Position',[160 10 (handle_size(3)-190) 25],...
    'String','20',...
    'TooltipString','Height of the gap above the residuals axis in pixels',...
    'Callback',{@edit_Callback,'residualsaxisgap'}...
    );

handle_pp4_3 = uipanel('Tag','display_panel_gaxis_panel',...
    'Parent',handle_pp4,...
    'BackgroundColor',defaultBackground,...
    'FontUnit','Pixel','Fontsize',12,...
    'Units','Pixels',...
    'Position',[0 handle_size(4)-460 handle_size(3)-20 60],...
    'Title','g axis'...
    );
...
handle_pp5_1 = uipanel('Tag','display_panel_datasets_panel',...
    'Parent',handle_pp5,...
    'BackgroundColor',defaultBackground,...
    'FontUnit','Pixel','Fontsize',12,...
    'Units','Pixels',...
...
handle_pp5_2 = uipanel('Tag','display_panel_line_panel',...
    'Parent',handle_pp5,...
    'BackgroundColor',defaultBackground,...
    'FontUnit','Pixel','Fontsize',12,...
    'Units','Pixels',...
...
handle_pp6_1 = uipanel('Tag','display_panel_3Ddisplay_panel',...
    'Parent',handle_pp6,...
    'BackgroundColor',defaultBackground,...
    'FontUnit','Pixel','Fontsize',12,...
    'Units','Pixels',...
    'Position',[0 handle_size(4)-450 handle_size(3)-20 370],...
    'Title','3D display'...
    );
...
uicontrol('Tag','display_panel_3D_reducing_text',...
    ...
    'FontAngle','italic',...
    'Units','Pixels',...
    'Position',[10 285 80 20],...
    'TooltipString','Set parameters to reduce data points in x and y',...
    'String','Reducing'...
    );
uicontrol('Tag','display_panel_reducing_auto_checkbox',...
    'Style','checkbox',...
    'Parent',handle_pp6_1,...
    'BackgroundColor',defaultBackground,...
    'FontUnit','Pixel','Fontsize',12,...
    'Units','Pixels',...
    'Position',[100 285 handle_size(3)-120 20],...
    'String',' automatic',...
    'TooltipString','Toggle between automatic and manual reduction',...
    'Value',1, ...
    'Callback',{@checkbox_Callback,'3dreduction'} ...
    );
uicontrol('Tag','display_panel_3D_x_text',...
    ...
    'FontUnit','Pixel','Fontsize',12,...
    'Units','Pixels',...
    'Position',[100 255 (handle_size(3)-130)/2 20],...
    'String','x'...
    );
uicontrol('Tag','display_panel_3D_y_text',...
    ...
    'FontUnit','Pixel','Fontsize',12,...
    'Units','Pixels',...
    'Position',[100+(handle_size(3)-130)/2 255 (handle_size(3)-130)/2 20],...
    'String','y'...
    );
...
uicontrol('Tag','display_panel_3D_factor_x_edit',...
    ...
    'FontUnit','Pixel','Fontsize',12,...
    'Units','Pixels',...
    'Position',[100 205 (handle_size(3)-130)/2 25],...
    'String','1',...
...
uicontrol('Tag','display_panel_3D_factor_y_edit',...
    ...
    'FontUnit','Pixel','Fontsize',12,...
    'Units','Pixels',...
    'Position',[100+(handle_size(3)-130)/2 205 (handle_size(3)-130)/2 25],...
    'String','1',...
...
uicontrol('Tag','display_panel_3D_size_x_edit',...
    ...
    'FontUnit','Pixel','Fontsize',12,...
    'Units','Pixels',...
    'Position',[100 180 (handle_size(3)-130)/2 25],...
    'String','1',...
    'Enable','inactive'...
    );
uicontrol('Tag','display_panel_3D_size_y_edit',...
    ...
    'FontUnit','Pixel','Fontsize',12,...
    'Units','Pixels',...
    'Position',[100+(handle_size(3)-130)/2 180 (handle_size(3)-130)/2 25],...
    'String','1',...
    'Enable','inactive'...
    );
...
uicontrol('Tag','display_panel_3D_offset_type_popupmenu',...
    ...
    'FontUnit','Pixel','Fontsize',12,...
    'Units','Pixels',...
    'Position',[10 122 80 20],...
    'String','auto|left|right',...
    'TooltipString','Select type of offset', ...
    'Callback',{@popupmenu_Callback,'3Doffset'}...
    );
uicontrol('Tag','display_panel_3D_offset_x_edit',...
    ...
    'FontUnit','Pixel','Fontsize',12,...
    'Units','Pixels',...
    'Position',[100 120 (handle_size(3)-130)/2 25],...
    'String','0',...
...
uicontrol('Tag','display_panel_3D_offset_y_edit',...
    ...
    'FontUnit','Pixel','Fontsize',12,...
    'Units','Pixels',...
    'Position',[100+(handle_size(3)-130)/2 120 (handle_size(3)-130)/2 25],...
    'String','0',...
    'TooltipString','Offset by which to shift the (reduced) data in y',...
    'Callback',{@show3d_edit_Callback,'yoffset'}...
    );
uicontrol('Tag','display_panel_3D_setvoi_pushbutton',...
    'Style','pushbutton',...
    'Parent',handle_pp6_1,...
    'BackgroundColor',defaultBackground,...
    'FontUnit','Pixel','Fontsize',12,...
    'Units','Pixels',...
    'Position',[100 80 (handle_size(3)-130)/2 30],...
    'String','Set VOI',...
    'TooltipString',['<html>Set current 3D representation as '...
    'view of interest (VOI)<br> in currently active dataset'],...
    'Callback',{@pushbutton_Callback,'setvoi'}...
    );
uicontrol('Tag','display_panel_3D_show_pushbutton',...
    ...
    'FontUnit','Pixel','Fontsize',12,...
    'Units','Pixels',...
    'Position',[100+(handle_size(3)-130)/2 80 (handle_size(3)-130)/2 30],...
    'String','Show',...
    'TooltipString',sprintf('%s\n%s',...
    'Show currently active dataset in given representation',...
    'as 3D display'),...
    'Callback',{@pushbutton_Callback,'show3D'}...
    );
...
uicontrol('Tag','display_panel_axes3Dexport_filetype_text',...
    'Style','text',...
    'Parent',handle_pp6_1,...
    'BackgroundColor',defaultBackground,...
    'FontUnit','Pixel','Fontsize',12,...
...
handle_pp7_1 = uipanel('Tag','display_panel_axesexport_panel',...
    'Parent',handle_pp7,...
    'BackgroundColor',defaultBackground,...
    'FontUnit','Pixel','Fontsize',12,...
    'Units','Pixels',...
