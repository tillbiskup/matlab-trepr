function [status,warnings] = cmdPanel(handle,opt,varargin)
% CMDPANEL Command line command of the trEPR GUI.
%
% Usage:
%   cmdPanel(handle,opt)
%   [status,warnings] = cmdPanel(handle,opt)
%
%   handle  - handle
