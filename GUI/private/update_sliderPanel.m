...
set(...
    ...
    'String',...
    num2str(ad.data{active}.display.scaling.x)...
    );
set(...
    gh.slider_panel_scaling_x_unit_edit,...
    'String',...
    num2str(...
    (((x(end)-x(1))*ad.data{active}.display.scaling.x))-...
    (x(end)-x(1)))...
    );
set(...
    gh.slider_panel_scaling_y_index_edit,...
    'String',...
    num2str(ad.data{active}.display.scaling.y)...
    );
set(...
    gh.slider_panel_scaling_y_unit_edit,...
    'String',...
    num2str(...
    (((y(end)-y(1))*ad.data{active}.display.scaling.y))-...
    (y(end)-y(1)))...
    );
set(...
...
set(...
    ...
    'String',...
    num2str(ad.data{active}.display.displacement.x));
set(...
...
set(...
    ...
    'String',...
    num2str(ad.data{active}.display.displacement.y));
set(...
...
set(...
    ...
    'String',...
    num2str(ad.data{active}.display.displacement.z)...
    );
set(...
...
switch ad.control.axis.displayType
    ...
    case '1D along x' % time profile
        ...
        if (ad.data{active}.display.scaling.z > 1)
            set(gh.vert2_slider,...
                'Value',...
                ad.data{active}.display.scaling.z-...
            ...
            set(gh.vert2_slider,...
                'Value',...
                -(1/ad.data{active}.display.scaling.z-...
                get(gh.vert2_slider,'Max'))...
                );
        end
        if (ad.data{active}.display.scaling.x > 1)
            ...
            set(gh.horz1_slider,...
                'Value',...
                -(1/ad.data{active}.display.scaling.x-...
                get(gh.horz1_slider,'Max'))...
                );
        end
    ...
    case '1D along y' % B0 spectrum
        ...
        if (ad.data{active}.display.scaling.y > 1)
            ...
            set(gh.horz1_slider,...
                'Value',...
                -(1/ad.data{active}.display.scaling.y-...
                get(gh.horz1_slider,'Max'))...
                );
        end
        % Update displacement slider
