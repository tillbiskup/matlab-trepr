...
hp7 = uipanel('Tag','analysis_panel',...
    'Title','Data analysis',...
    'FontWeight','bold',...
    'BackgroundColor',defaultBackground,...
    'Visible','off',...
    'Units','pixels','Position',[guiSize(1)-mainPanelWidth-20 20 mainPanelWidth guiSize(2)-140]);

% Create the "Analysis" panel
hp7_size = get(hp7,'Position');
uicontrol('Tag','panel_analysis_description',...
    'Style','text',...
    'Parent',hp7,...
    'BackgroundColor',defaultBackground,...
    'Units','Pixels',...
    ...
    'FontAngle','oblique',...
    'Position',[10 hp7_size(4)-60 hp7_size(3)-20 30],...
