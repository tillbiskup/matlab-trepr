...
uicontrol('Tag','functionButtonGroup_function1_pushbutton',...
    ...
    'FontUnit','Pixel','Fontsize',12,...
    'String','Help',...
    'TooltipString','Display help for how to operate the GUI (F1)',...
...
uicontrol('Tag','functionButtonGroup_function2_pushbutton',...
    ...
    'FontUnit','Pixel','Fontsize',12,...
    'String','About',...
    'TooltipString','Open "Help:About" window with basic information about the GUI and toolbox (F2)',...
...
uicontrol('Tag','functionButtonGroup_function3_pushbutton',...
    ...
    'FontUnit','Pixel','Fontsize',12,...
    'String','Info',...
    'TooltipString','Show information about currently active dataset (F3)',...
...
uicontrol('Tag','functionButtonGroup_function4_pushbutton',...
    ...
    'FontUnit','Pixel','Fontsize',12,...
    'String','BLC',...
    'TooltipString','Perform baseline correction (BLC) on currently active dataset (new window, F4)',...
...
uicontrol('Tag','functionButtonGroup_function5_pushbutton',...
    ...
    'FontUnit','Pixel','Fontsize',12,...
    'String','ACC',...
    'TooltipString','Accumulate (currently visible) datasets (new window, F5)',...
...
uicontrol('Tag','functionButtonGroup_function6_pushbutton',...
    ...
    'FontUnit','Pixel','Fontsize',12,...
    'String','SVD',...
    'TooltipString','Perform basic singular value decomposition (SVD) on currently active dataset (new window, F6)',...
...
uicontrol('Tag','functionButtonGroup_function7_pushbutton',...
    ...
    'FontUnit','Pixel','Fontsize',12,...
    'String','Fitting',...
    'TooltipString','Show basic fitting options for current display of currently active dataaet (new window, F7)',...
...
uicontrol('Tag','tbHelp',...
    ...
    'FontUnit','Pixel','Fontsize',12,...
    'String','Help',...
    'TooltipString','Access builtin help',...
