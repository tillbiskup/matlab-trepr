...
pp2 = uipanel('Tag','analyse_panel',...
    ...
    'Visible','off',...
    'Units','pixels',...
    'Position',[guiSize(1)-mainPanelWidth-20 80 mainPanelWidth 540]);
...
%     'FontUnit','Pixel','Fontsize',12,...
%     'Units','Pixels',...
%     'Position',[10 40 (mainPanelWidth-40) 50],...
%     'ColumnName', {'#','x/y','index','unit'},...
%     'ColumnFormat',{'numeric',{'x' 'y'},'numeric','numeric'},...
%     'ColumnWidth',{20 (mainPanelWidth-65)/3 (mainPanelWidth-65)/3 (mainPanelWidth-65)/3},...
%     'Data',{1 'y' 0 0},...
%     'RowName',[],...
...
uicontrol('Tag','referencelines_1_popupmenu',...
    'Style','popupmenu',...
    'Parent',pp1_p4,...
    'BackgroundColor',defaultBackground,...
    'FontUnit','Pixel','Fontsize',12,...
...
uicontrol('Tag','referencelines_1_index_edit',...
    'Style','edit',...
    'Parent',pp1_p4,...
    'BackgroundColor',[1 1 1],...
    'FontUnit','Pixel','Fontsize',12,...
...
uicontrol('Tag','referencelines_1_unit_edit',...
    'Style','edit',...
    'Parent',pp1_p4,...
    'BackgroundColor',[1 1 1],...
    'FontUnit','Pixel','Fontsize',12,...
...
uicontrol('Tag','referencelines_2_popupmenu',...
    'Style','popupmenu',...
    'Parent',pp1_p4,...
    'BackgroundColor',defaultBackground,...
    'FontUnit','Pixel','Fontsize',12,...
    'Units','Pixels',...
    'Position',[10 12 60 20],...
    'TooltipString',sprintf('%s\n%s',...
    'Type of the reference line',...
    'h - horizontal; v - vertical'),...
    'String','h|v',...
...
uicontrol('Tag','referencelines_2_index_edit',...
    'Style','edit',...
    'Parent',pp1_p4,...
    'BackgroundColor',[1 1 1],...
    'FontUnit','Pixel','Fontsize',12,...
    'Units','Pixels',...
    'Position',[70 10 (mainPanelWidth-100)/2 25],...
    'String','0',...
    'Callback',{@position_edit_Callback,'yindex'}...
    );
uicontrol('Tag','referencelines_2_unit_edit',...
    'Style','edit',...
    'Parent',pp1_p4,...
    'BackgroundColor',[1 1 1],...
    'FontUnit','Pixel','Fontsize',12,...
    'Units','Pixels',...
    'Position',[70+(mainPanelWidth-100)/2 10 (mainPanelWidth-100)/2 25],...
    'String','0',...
    'Callback',{@position_edit_Callback,'yunit'}...
    );
