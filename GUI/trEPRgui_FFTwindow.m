...
uicontrol('Tag','pickfrequency_x_text',...
    'Style','text',...
    'Parent',pp2_p1,...
    'BackgroundColor',defaultBackground,...
    'FontUnit','Pixel','Fontsize',12,...
...
pp2_p2 = uipanel('Tag','zoom_panel',...
    ...
    'FontUnit','Pixel','Fontsize',12,...
    'Units','Pixels',...
    'Position',[10 mainPanelHeight-200 mainPanelWidth-20 60],...
    'Title','Zoom'...
    );
...
pp2_p3 = uipanel('Tag','fitarea_panel',...
    'Parent',pp2,...
    'BackgroundColor',defaultBackground,...
    'FontUnit','Pixel','Fontsize',12,...
    'Units','Pixels',...
    'Position',[10 mainPanelHeight-350 mainPanelWidth-20 140],...
    'Title','Fit'...
    );
...
pp2_p4 = uipanel('Tag','fitarea_panel',...
    'Parent',pp2,...
    'BackgroundColor',defaultBackground,...
    'FontUnit','Pixel','Fontsize',12,...
    'Units','Pixels',...
    'Position',[10 mainPanelHeight-470 mainPanelWidth-20 110],...
    'Title','Cut'...
    );
uicontrol('Tag','fitarea_start_text',...
    'Style','text',...
