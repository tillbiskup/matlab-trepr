...
if ishghandle(mainGuiWindow)
    ...
    for m=1:length(ad.data)
        ...
        if (ad.data{m}.display.displacement.data(1) ~= 0)
            % Get axis stepping
            xStep = ad.data{m}.axes.data(1).values(2)-ad.data{m}.axes.data(1).values(1);
            % Set new axes values
            ad.data{m}.axes.data(1).values = ad.data{m}.axes.data(1).values + ...
                (xStep*ad.data{m}.display.displacement.data(1));
        end
        if (ad.data{m}.display.displacement.data(2) ~= 0)
            % Get axis stepping
            yStep = ad.data{m}.axes.data(2).values(2)-ad.data{m}.axes.data(2).values(1);
            % Set new axes values
            ad.data{m}.axes.data(2).values = ad.data{m}.axes.data(2).values + ...
                (yStep*ad.data{m}.display.displacement.data(2));
        end
        if (ad.data{m}.display.displacement.data(3) ~= 0)
            ad.data{m}.data = ...
                ad.data{m}.data + ad.data{m}.display.displacement.data(3);
        end
        % Handle scaling along all three axes
        if (ad.data{m}.display.scaling.data(1) ~= 0)
        end
        if (ad.data{m}.display.scaling.data(2) ~= 0)
        end
        if (ad.data{m}.display.scaling.data(3) ~= 0)
        end
        % set appdata
        setappdata(hMainFigure,'data',ad.data);
    end
        ...
        switch ad.control.axis.displayType
            case '1D along x'
                if isfield(ad.acc,'data')
                    ad.acc.data.display.position.data(2) = ...
            ...
            case '1D along y'
                if isfield(ad.acc,'data')
                    ad.acc.data.display.position.data(1) = ...
                        int16(get(source,'Value'));
                else
...
function position_edit_Callback(source,~,position)
    try
        ...
        x = ad.acc.data.axes.data(1).values;
        y = ad.acc.data.axes.data(2).values;
        ...
        switch position
            ...
            case 'xunit'
                ...
                ad.acc.data.display.position.data(1) = value;
            case 'yindex'
                if strcmpi(value,'end')
                    value = length(y);
                else
                ...
                ad.acc.data.display.position.data(2) = value;
            case 'yunit'
                if strcmpi(value,'end')
                    value = x(end);
                else
            ...
            case 'Datasets'
                if isempty(ad.control.data.active) || ...
                    ...
                    set(gh.dataset_dimensions_min_x_edit,'String',...
                        num2str(ad.data{ad.control.data.active}.axes.data(1).values(1)));
                    set(gh.dataset_dimensions_min_y_edit,'String',...
                        num2str(ad.data{ad.control.data.active}.axes.data(2).values(1)));
                    set(gh.dataset_dimensions_max_x_edit,'String',...
                        num2str(ad.data{ad.control.data.active}.axes.data(1).values(end)));
                    set(gh.dataset_dimensions_max_y_edit,'String',...
                        num2str(ad.data{ad.control.data.active}.axes.data(2).values(end)));
                    set(gh.dataset_dimensions_step_x_edit,'String',...
                        num2str(ad.data{ad.control.data.active}.axes.data(1).values(2)-...
                        ad.data{ad.control.data.active}.axes.data(1).values(1)));
                    if ydim > 1
                        set(gh.dataset_dimensions_step_y_edit,'String',...
                            num2str(ad.data{ad.control.data.active}.axes.data(2).values(2)-...
            ...
            case 'Results'
                if isempty(ad.acc.data)
                    ...
                    set(gh.accdimensions_min_x_edit,'String',...
                        num2str(ad.acc.data.axes.data(1).values(1)));
                    set(gh.accdimensions_min_y_edit,'String',...
                        num2str(ad.acc.data.axes.data(2).values(1)));
                    set(gh.accdimensions_max_x_edit,'String',...
                        num2str(ad.acc.data.axes.data(1).values(end)));
                    set(gh.accdimensions_max_y_edit,'String',...
                        num2str(ad.acc.data.axes.data(2).values(end)));
                    set(gh.accdimensions_step_x_edit,'String',...
                        num2str(ad.acc.data.axes.data(1).values(2)-...
                        ad.acc.data.axes.data(1).values(1)));
                    if ydim > 1
                        set(gh.accdimensions_step_y_edit,...
                            'String',...
                            num2str(ad.acc.data.axes.data(2).values(2)-...
                            ad.acc.data.axes.data(2).values(1)));
                    else
                        set(gh.accdimensions_step_y_edit,...
                            'String','0');
                    end
    ...
    try
        ...
        if isfield(ad.acc,'data') && ~isempty(ad.acc.data)
            ...
            set(...
                ...
                'string',...
                x(ad.acc.data.display.position.data(1))...
                );
            set(...
            ...
            set(...
                ...
                'string',...
                y(ad.acc.data.display.position.data(2))...
                );
        end
    catch exception
        trEPRexceptionHandling(exception)
        ...
        if isfield(ad.acc,'data') && ~isempty(ad.acc.data)
            ...
            switch ad.control.axis.displayType
                case '2D plot'
                    ...
                    xlabel(gca,...
                        sprintf('{\\it %s} / %s',...
                        ad.acc.data.axes.data(1).measure,...
                        ad.acc.data.axes.data(1).unit));
                    ylabel(gca,...
                        sprintf('{\\it %s} / %s',...
                        ad.acc.data.axes.data(2).measure,...
                        ad.acc.data.axes.data(2).unit));
                case '1D along x'
                    ...
                    if (length(y)>1)
                        set(gh.slider,...
                            ...
                            'Value',ad.acc.data.display.position.data(2)...
                            );
                    else
                        set(gh.slider,...
                            'Enable','off'...
                ...
                case '1D along y'
                    ...
                    if (length(x)>1)
                        set(gh.slider,...
                            ...
                            'Value',ad.acc.data.display.position.data(1)...
                            );
                    else
                        set(gh.slider,...
                            'Enable','off'...
                ...
                case '1D along x'
                    ...
                    if ad.control.axis.onlyActive
                        ...
                        for idx=1:length(ad.control.data.accumulated)
                            ...
                            y = ad.data{k}.data(...
                                ad.data{k}.display.position.data(2),...
                                :);
                            % In case that we loaded 1D data...
                            if isscalar(x)
                                x = [x x+1]; %#ok<AGROW>
                    ...
                    % Plot axis labels
                    if isempty(ad.data{active}.axes.data(1).unit)
                        xlabel(gca,...
                            sprintf('{\\it %s}',...
                            ad.data{active}.axes.data(1).measure));
                    else
                    ...
                    if isempty(ad.data{active}.axes.data(3).unit)
                        ylabel(gca,...
                            sprintf('{\\it %s}',...
                            ad.data{active}.axes.data(3).measure));
                    else
                        ylabel(gca,...
                            sprintf('{\\it %s} / %s',...
                            ad.data{active}.axes.data(3).measure,...
                            ad.data{active}.axes.data(3).unit));
                    end
                case '1D along y'
                    % Enable position slider only if second axis has more
                    % than one value 
                    ...
                    if ad.control.axis.onlyActive
                        ...
                        for idx=1:length(ad.control.data.accumulated)
                            ...
                            x = ad.data{k}.data(...
                                :,...
                                ad.data{k}.display.position.data(1)...
                                );
                            % In case that we loaded 1D data...
                            if isscalar(x)
                                x = [x x+1]; %#ok<AGROW>
                    ...
                    % Plot axis labels
                    if isempty(ad.data{active}.axes.data(2).unit)
                        xlabel(gca,...
                            sprintf('{\\it %s}',...
                            ad.data{active}.axes.data(2).measure));
                    else
