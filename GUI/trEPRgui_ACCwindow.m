...
% TREPRGUI_ACCWINDOW Provide user with all necessary controls to accumula
...
pp1_p4 = uipanel('Tag','displaytype_panel',...
    ...
    'FontUnit','Pixel','Fontsize',12,...
    'Units','Pixels',...
    'Position',[10 mainPanelHeight-540 panel_size 85],...
    'Title','Display types'...
    );
...
uicontrol('Tag','mfedisplaytype_popupmenu',...
    ...
    'String',...
    'MFoff|MFoff+MFon|MFoff+MFon+DeltaMF|MFon|DeltaMF|sum(MFoff,MFon)',...
...
pp3_p2 = uipanel('Tag','line_panel',...
    'Parent',pp3,...
    'BackgroundColor',defaultBackground,...
    'FontUnit','Pixel','Fontsize',12,...
    'Units','Pixels',...
    'Position',[10 mainPanelHeight-275 mainPanelWidth-20 185],...
    'Title','Line settings'...
    );
uicontrol('Tag','line_text',...
    'Style','text',...
    'Parent',pp3_p2,...
    'BackgroundColor',defaultBackground,...
    'FontUnit','Pixel','Fontsize',12,...
...
uicontrol('Tag','coloursample_text',...
    'Style','text',...
    'Parent',pp3_p2,...
...
uicontrol('Tag','colour_pushbutton',...
    'Style','pushbutton',...
    'Parent',pp3_p2,...
    'BackgroundColor',defaultBackground,...
    'Enable','on',...
...
uicontrol('Tag','linewidth_popupmenu',...
    'Style','popupmenu',...
    'Parent',pp3_p2,...
    'BackgroundColor',defaultBackground,...
    'FontUnit','Pixel','Fontsize',12,...
...
uicontrol('Tag','linestyle_popupmenu',...
    'Style','popupmenu',...
    'Parent',pp3_p2,...
    'BackgroundColor',defaultBackground,...
    'FontUnit','Pixel','Fontsize',12,...
...
uicontrol('Tag','linemarker_popupmenu',...
    'Style','popupmenu',...
    'Parent',pp3_p2,...
    'BackgroundColor',defaultBackground,...
    'FontUnit','Pixel','Fontsize',12,...
...
pp3_p3 = uipanel('Tag','weighting_sn_panel',...
    'parent',pp3,...
    ...
    'Visible','on',...
    'Units','pixels',...
    'Position',[10 mainPanelHeight-450 panel_size 165]);
