...
uicontrol('Tag','slider_panel_maximum_pushbutton',...
    ...
    'String','Min',...
    'TooltipString','Set position to minimum in both dimensions',...
    'Callback',{@pushbutton_Callback,'showMinimum'}...
    );
uicontrol('Tag','slider_panel_maximum_pushbutton',...
    'Style','pushbutton',...
    'Parent',pp1_p3,...
    ...
    try
        ...
        switch action
            case 'showMinimum'
                ...
                ad.data{ad.control.data.active}.display.position.x = ximin;
                ad.data{ad.control.data.active}.display.position.y = yimin;
...
function updateSliderPanel()
    try
        ...
        set(...
            ...
            'string',...
            x(ad.data{ad.control.data.active}.display.position.x)...
            );
        set(...
        ...
        set(...
            ...
            'string',...
            y(ad.data{ad.control.data.active}.display.position.y)...
            );
    catch exception
        trEPRexceptionHandling(exception)
    end
...
%         end
    ...
    try
        ...
        xvalues = ad.data{ad.control.data.active}.axes.x.values;
        xmeasure = ad.data{ad.control.data.active}.axes.x.measure;
        xunit = ad.data{ad.control.data.active}.axes.x.unit;
        yvalues = ad.data{ad.control.data.active}.axes.y.values;
        ymeasure = ad.data{ad.control.data.active}.axes.y.measure;
        yunit = ad.data{ad.control.data.active}.axes.y.unit;
        ...
        switch ad.control.axis.displayType
            case '2D plot'
                ...
                if ad.control.axis.position
                    ...
                    plot(gh.axis,...
                        [xvalues(ad.data{ad.control.data.active}.display.position.x) ...
                        xvalues(ad.data{ad.control.data.active}.display.position.x)],...
                    ...
                    plot(gh.axis,...
                        ...
                        [yvalues(ad.data{ad.control.data.active}.display.position.y) ...
                        yvalues(ad.data{ad.control.data.active}.display.position.y)],...
                        'r-');
                end
                hold off;
