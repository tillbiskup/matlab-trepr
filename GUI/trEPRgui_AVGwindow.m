    ...
    try
        ...
        switch action
            case 'showMinimum'
                ...
                [~,ximin] = min(min(ad.data{ad.control.spectra.active}.data));
                [~,yimin] = min(ad.data{ad.control.spectra.active}.data(:,ximin));
                ad.data{ad.control.spectra.active}.display.position.x = ximin;
                ad.data{ad.control.spectra.active}.display.position.y = yimin;
