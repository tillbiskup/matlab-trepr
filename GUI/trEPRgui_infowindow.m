...
uicontrol('Tag','characteristics_panel_averageWindow_unit_edit',...
    'Style','edit',...
    'parent',p5p5_1,...
    'FontUnit','Pixel','Fontsize',12,...
    'BackgroundColor',editableBackground,...
...
uicontrol('Tag','characteristics_panel_soi_linecolour_pushbutton',...
    'Style','pushbutton',...
    'Parent',p5p5_2,...
    'BackgroundColor',defaultBackground,...
    'Enable','on',...
...
uicontrol('Tag','characteristics_panel_soi_linewidth_popupmenu',...
    'Style','popupmenu',...
    'Parent',p5p5_2,...
    'BackgroundColor',defaultBackground,...
    'FontUnit','Pixel','Fontsize',12,...
    'Units','Pixels',...
    'Position',[80 170 mainPanelWidth-90 20],...
...
uicontrol('Tag','characteristics_panel_soi_linemarker_text',...
    'Style','text',...
    'Parent',p5p5_2,...
    'BackgroundColor',defaultBackground,...
    'FontUnit','Pixel','Fontsize',12,...
...
uicontrol('Tag','characteristics_panel_soi_linemarker_popupmenu',...
    'Style','popupmenu',...
    'Parent',p5p5_2,...
    'BackgroundColor',defaultBackground,...
    'FontUnit','Pixel','Fontsize',12,...
...
uicontrol('Tag','characteristics_panel_soi_markeredgecolour_popupmenu',...
    ...
    'FontUnit','Pixel','Fontsize',12,...
    'Units','Pixels',...
    'Position',[80 75 mainPanelWidth-160 20],...
...
uicontrol('Tag','characteristics_panel_soi_markeredgecoloursample_text',...
    ...
    'FontUnit','Pixel','Fontsize',12,...
    'Units','Pixels',...
    'Position',[mainPanelWidth-75 73 35 25],...
    'TooltipString','0  0  0',...
    'String',''...
    );
uicontrol('Tag','characteristics_panel_soi_markeredgecolour_pushbutton',...
    'Style','pushbutton',...
    'Parent',p5p5_2,...
    'BackgroundColor',defaultBackground,...
    'Enable','on',...
...
uicontrol('Tag','characteristics_panel_soi_markerfacecolour_popupmenu',...
    ...
    'FontUnit','Pixel','Fontsize',12,...
    'Units','Pixels',...
    'Position',[80 45 mainPanelWidth-160 20],...
    'String','auto|none|colour',...
    'Value',2,...
...
uicontrol('Tag','characteristics_panel_soi_markerfacecoloursample_text',...
    ...
    'FontUnit','Pixel','Fontsize',12,...
    'Units','Pixels',...
    'Position',[mainPanelWidth-75 42 35 25],...
    'TooltipString','0  0  0',...
    'String',''...
    );
uicontrol('Tag','characteristics_panel_soi_markerfacecolour_pushbutton',...
    'Style','pushbutton',...
    'Parent',p5p5_2,...
    'BackgroundColor',defaultBackground,...
    'Enable','on',...
...
p5p6_1 = uipanel('Tag','characteristics_panel_poi_parameters_panel',...
    ...
    'Visible','on',...
    'Units','pixels',...
    'Position',[5 150 mainPanelWidth 105]);
uicontrol('Tag','characteristics_panel_poi_coordinates_text',...
    ...
    'HorizontalAlignment','Left',...
    'Units','Pixels',...
    'Position',[10 60 mainPanelWidth-20 20],...
    'String','Coordinates'...
    );
uicontrol('Tag','characteristics_panel_poi_coordinates_index_text',...
    ...
    'FontUnit','Pixel','Fontsize',12,...
    'Units','Pixels',...
    'Position',[40 35 (mainPanelWidth-50)/2 20],...
    'String','index'...
    );
uicontrol('Tag','characteristics_panel_poi_coordinates_units_text',...
    ...
    'FontUnit','Pixel','Fontsize',12,...
    'Units','Pixels',...
    'Position',[(mainPanelWidth-50)/2+40 35 (mainPanelWidth-50)/2 20],...
    'String','units'...
    );
uicontrol('Tag','characteristics_panel_poi_coordinates_index_edit',...
    'Style','edit',...
    'parent',p5p6_1,...
    'FontUnit','Pixel','Fontsize',12,...
    'BackgroundColor',editableBackground,...
...
uicontrol('Tag','characteristics_panel_poi_coordinates_unit_edit',...
    'Style','edit',...
    'parent',p5p6_1,...
    'FontUnit','Pixel','Fontsize',12,...
    'BackgroundColor',editableBackground,...
...
uicontrol('Tag','characteristics_panel_poi_linemarker_text',...
    'Style','text',...
    'Parent',p5p6_2,...
    'BackgroundColor',defaultBackground,...
    'FontUnit','Pixel','Fontsize',12,...
...
uicontrol('Tag','characteristics_panel_poi_linemarker_popupmenu',...
    'Style','popupmenu',...
    'Parent',p5p6_2,...
    'BackgroundColor',defaultBackground,...
    'FontUnit','Pixel','Fontsize',12,...
...
uicontrol('Tag','characteristics_panel_poi_markeredgecolour_pushbutton',...
    'Style','pushbutton',...
    'Parent',p5p6_2,...
    'BackgroundColor',defaultBackground,...
    'Enable','on',...
...
uicontrol('Tag','characteristics_panel_poi_markerfacecolour_pushbutton',...
    'Style','pushbutton',...
    'Parent',p5p6_2,...
    'BackgroundColor',defaultBackground,...
    'Enable','on',...
...
uicontrol('Tag','characteristics_panel_doi_linecolour_pushbutton',...
    'Style','pushbutton',...
    'Parent',p5p7_2,...
    'BackgroundColor',defaultBackground,...
    'Enable','on',...
...
uicontrol('Tag','characteristics_panel_doi_linewidth_popupmenu',...
    'Style','popupmenu',...
    'Parent',p5p7_2,...
    'BackgroundColor',defaultBackground,...
    'FontUnit','Pixel','Fontsize',12,...
...
uicontrol('Tag','characteristics_panel_doi_linemarker_text',...
    'Style','text',...
    'Parent',p5p7_2,...
    'BackgroundColor',defaultBackground,...
    'FontUnit','Pixel','Fontsize',12,...
...
uicontrol('Tag','characteristics_panel_doi_linemarker_popupmenu',...
    'Style','popupmenu',...
    'Parent',p5p7_2,...
    'BackgroundColor',defaultBackground,...
    'FontUnit','Pixel','Fontsize',12,...
...
uicontrol('Tag','characteristics_panel_doi_markeredgecolour_pushbutton',...
    'Style','pushbutton',...
    'Parent',p5p7_2,...
    'BackgroundColor',defaultBackground,...
    'Enable','on',...
...
uicontrol('Tag','characteristics_panel_doi_markerfacecolour_pushbutton',...
    'Style','pushbutton',...
    'Parent',p5p7_2,...
    'BackgroundColor',defaultBackground,...
    'Enable','on',...
...
uicontrol('Tag','characteristics_panel_voi_x_text',...
    ...
    'FontUnit','Pixel','Fontsize',12,...
    'Units','Pixels',...
    'Position',[100 160 (mainPanelWidth-130)/2 20],...
    'String','x'...
    );
uicontrol('Tag','characteristics_panel_voi_y_text',...
    ...
    'FontUnit','Pixel','Fontsize',12,...
    'Units','Pixels',...
    'Position',[100+(mainPanelWidth-130)/2 160 (mainPanelWidth-130)/2 20],...
    'String','y'...
    );
...
uicontrol('Tag','display_panel_offset_auto_checkbox',...
    ...
    'FontUnit','Pixel','Fontsize',12,...
    'Units','Pixels',...
    'Position',[100 40 mainPanelWidth-120 20],...
    'String',' automatic',...
...
uicontrol('Tag','characteristics_panel_voi_edgecolour_popupmenu',...
    ...
    'FontUnit','Pixel','Fontsize',12,...
    'Units','Pixels',...
    'Position',[90 152 mainPanelWidth-170 20],...
...
uicontrol('Tag','characteristics_panel_voi_edgecoloursample_text',...
    ...
    'FontUnit','Pixel','Fontsize',12,...
    'Units','Pixels',...
    'Position',[mainPanelWidth-75 150 35 25],...
    'TooltipString','0  0  0',...
    'String',''...
    );
uicontrol('Tag','characteristics_panel_voi_edgecolour_pushbutton',...
    'Style','pushbutton',...
    'Parent',p5p8_2,...
    'BackgroundColor',defaultBackground,...
    'Enable','on',...
    ...
    'String','...',...
    'TooltipString',sprintf('%s\n%s',...
    'Open colour palette for specifying','surface edge colour'),...
    'Callback',{@pushbutton_Callback,'voiEdgeColourPalette'}...
    );
...
function updateCharacteristicsPanel()
    try
        ...
        if ad.info.characteristics.(ad.info.characteristics.type).count > 0
            labels = cell(1,ad.info.characteristics.(ad.info.characteristics.type).count);
            for idx = 1:ad.info.characteristics.(ad.info.characteristics.type).count
                labels{idx} = ...
                    ad.data{ad.control.spectra.active}.characteristics.(...
                    ad.info.characteristics.type)(idx).label;
            end
            if get(gh.characteristics_panel_list_listbox,'Value') > ...
                    ad.info.characteristics.(ad.info.characteristics.type).count
            ...
            selChar = get(gh.characteristics_panel_list_listbox,'Value');
            set(gh.characteristics_panel_label_edit,'String',...
                ad.data{ad.control.spectra.active}.characteristics.(...
                    ad.info.characteristics.type)(selChar).label);
            set(gh.characteristics_panel_comment_edit,'String',...
                ad.data{ad.control.spectra.active}.characteristics.(...
                    ad.info.characteristics.type)(selChar).comment);            
        else
