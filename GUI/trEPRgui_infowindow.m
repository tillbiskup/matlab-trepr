...
p2p3 = uipanel('Tag','parameter_transient_panel',...
    'parent',p2pp1,...
    'Title','Transient',...
    'FontUnit','Pixel','Fontsize',12,...
    'BackgroundColor',defaultBackground,...
    'Visible','on',...
    'Units','pixels',...
    'Position',[0 subPanelHeight-500 mainPanelWidth 120]);
...
uicontrol('Tag','parameter_panel_length_edit',...
    ...
    'Position',[110 10 (mainPanelWidth-120)/3*2 25],...
    'String','0',...
    'Callback',{@parameter_edit_Callback,'length'}...
    );
uicontrol('Tag','parameter_panel_length_unit_edit',...
    ...
    'Position',[110+(mainPanelWidth-120)/3*2 10 (mainPanelWidth-120)/3 25],...
    'String','us',...
    'Callback',{@parameter_edit_Callback,'lengthunit'}...
    );
...
p2p4 = uipanel('Tag','parameter_field_panel',...
    ...
    'Visible','on',...
    'Units','pixels',...
    'Position',[mainPanelWidth+10 subPanelHeight-500 mainPanelWidth 280]);
...
p2p5 = uipanel('Tag','parameter_probehead_panel',...
    'parent',p2pp2,...
    'Title','Probehead',...
    'FontUnit','Pixel','Fontsize',12,...
    'BackgroundColor',defaultBackground,...
    'Visible','on',...
    'Units','pixels',...
    'Position',[0 subPanelHeight-60 mainPanelWidth 60]);
...
p2p6 = uipanel('Tag','parameter_recorder_panel',...
    'parent',p2pp2,...
    'Title','Recorder',...
    'FontUnit','Pixel','Fontsize',12,...
    'BackgroundColor',defaultBackground,...
    'Visible','on',...
    'Units','pixels',...
    'Position',[mainPanelWidth+10 subPanelHeight-240 mainPanelWidth 240]);
...
uicontrol('Tag','parameter_panel_timebase_edit',...
    ...
    'Position',[110 70 (mainPanelWidth-120)/3*2 25],...
    'String','0',...
    'Callback',{@parameter_edit_Callback,'timebase'}...
    );
uicontrol('Tag','parameter_panel_timebaseunit_edit',...
    ...
    'Position',[110+(mainPanelWidth-120)/3*2 70 (mainPanelWidth-120)/3 25],...
    'String','us',...
    'Callback',{@parameter_edit_Callback,'timebaseunit'}...
    );
...
uicontrol('Tag','parameter_panel_bandwidth_edit',...
    ...
    'Position',[110 40 (mainPanelWidth-120)/3*2 25],...
    'String','0',...
    'Callback',{@parameter_edit_Callback,'bandwidth'}...
    );
uicontrol('Tag','parameter_panel_bandwidthunit_edit',...
    ...
    'Position',[110+(mainPanelWidth-120)/3*2 40 (mainPanelWidth-120)/3 25],...
    'String','MHz',...
    'Callback',{@parameter_edit_Callback,'bandwidthunit'}...
    );
...
uicontrol('Tag','parameter_panel_sensitivity_edit',...
    ...
    'Position',[110 10 (mainPanelWidth-120)/3*2 25],...
    'String','0',...
    'Callback',{@parameter_edit_Callback,'sensitivity'}...
    );
uicontrol('Tag','parameter_panel_sensitivity_unit_edit',...
    ...
    'Position',[110+(mainPanelWidth-120)/3*2 10 (mainPanelWidth-120)/3 25],...
    'String','mV',...
    'Callback',{@parameter_edit_Callback,'sensitivityunit'}...
    );
...
p2p7 = uipanel('Tag','parameter_bridge_panel',...
    ...
    'Visible','on',...
    'Units','pixels',...
    'Position',[0 subPanelHeight-450 mainPanelWidth 380]);
...
uicontrol('Tag','parameter_panel_attenuation_edit',...
    ...
    'String','0',...
    'Callback',{@parameter_edit_Callback,'attenuation'}...
    );
...
uicontrol('Tag','parameter_panel_amplification_edit',...
    ...
    'String','0',...
    'Callback',{@parameter_edit_Callback,'amplification'}...
    );
...
p2p8 = uipanel('Tag','parameter_laser_panel',...
    'parent',p2pp2,...
    'Title','Laser',...
    'FontUnit','Pixel','Fontsize',12,...
    'BackgroundColor',defaultBackground,...
    'Visible','on',...
    'Units','pixels',...
    'Position',[mainPanelWidth+10 subPanelHeight-430 mainPanelWidth 180]);
...
uicontrol('Tag','parameter_panel_wavelength_edit',...
    ...
    'Position',[110 70 (mainPanelWidth-120)/3*2 25],...
    'String','0',...
    'Callback',{@parameter_edit_Callback,'wavelength'}...
    );
...
uicontrol('Tag','parameter_panel_repetitionrate_edit',...
    ...
    'Position',[110 40 (mainPanelWidth-120)/3*2 25],...
    'String','0',...
    'Callback',{@parameter_edit_Callback,'repetitionrate'}...
    );
...
function updateParameterPanel()
    try
        ...
        % needed.
        matchingSample = {...
%            'parameter_panel_samplename_edit','','name',''; ...
            'parameter_panel_sampletube_edit','','tube',''; ...
            'parameter_panel_sampledescription_edit','','description',''; ...
%            'parameter_panel_samplepreparation_edit','','preparation',''; ...
            };
        matchingParameter = {...
