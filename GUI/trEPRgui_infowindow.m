...
uicontrol('Tag','parameter_panel_calibrationmethod_popupmenu',...
    'Style','popupmenu',...
    'Parent',p2p6,...
    'BackgroundColor',editableBackground,...
    'FontUnit','Pixel','Fontsize',12,...
...
p2p6_1 = uipanel('Tag','parameter_fieldcalibration_standard_panel',...
    ...
    'Visible','on',...
    'Units','pixels',...
    'Position',[5 5 mainPanelWidth-10 125],...
    'Visible','on');
...
uicontrol('Tag','parameter_panel_backgroundfieldunit_edit',...
    ...
    'Position',[110+(mainPanelWidth-120)/3*2 70 (mainPanelWidth-120)/3 25],...
    'String','G',...
    'Callback',{@parameter_edit_Callback,'backgroundfieldedit'}...
    );
...
p2p12 = uipanel('Tag','parameter_laser_panel',...
    ...
    'Visible','on',...
    'Units','pixels',...
    'Position',[mainPanelWidth+10 subPanelHeight-310 mainPanelWidth 310]);
