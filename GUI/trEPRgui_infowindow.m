...
p1p3 = uipanel('Tag','general_panel_header_panel',...
    ...
    'Visible','on',...
    'Units','pixels',...
    'Position',[10 170 mainPanelWidth*2+10 230]);
...
uicontrol('Tag','general_panel_comment_edit',...
    ...
    'Units','pixels',...
    'String','Comment',...
    'Position',[10 10 mainPanelWidth*2-10 120],...
...
p2p6 = uipanel('Tag','parameter_field_panel',...
    ...
    'Visible','on',...
    'Units','pixels',...
    'Position',[0 subPanelHeight-340 mainPanelWidth 340]);
...
uicontrol('Tag','parameter_panel_fieldpts_edit',...
    ...
    'FontUnit','Pixel','Fontsize',12,...
    'Units','Pixels',...
    'Position',[110 290 (mainPanelWidth-120)/3*2 25],...
    'String','0'...
    );
uicontrol('Tag','parameter_panel_fieldpts_unit_edit',...
    ...
    'FontUnit','Pixel','Fontsize',12,...
    'Units','Pixels',...
    'Position',[110+(mainPanelWidth-120)/3*2 290 (mainPanelWidth-120)/3 25],...
    'String','pt'...
    );
...
p2p7 = uipanel('Tag','parameter_transient_panel',...
    'parent',p2pp2,...
    'Title','Transient',...
    'FontUnit','Pixel','Fontsize',12,...
    'BackgroundColor',defaultBackground,...
    'Visible','on',...
    'Units','pixels',...
    'Position',[0 subPanelHeight-470 mainPanelWidth 120]);
...
p2p8 = uipanel('Tag','parameter_bridge_panel',...
    'parent',p2pp2,...
    'Title','Bridge',...
    'FontUnit','Pixel','Fontsize',12,...
    'BackgroundColor',defaultBackground,...
...
p2p9 = uipanel('Tag','parameter_probehead_panel',...
    'parent',p2pp2,...
    'Title','Probehead',...
    'FontUnit','Pixel','Fontsize',12,...
    'BackgroundColor',defaultBackground,...
...
p2p10 = uipanel('Tag','parameter_recorder_panel',...
    'parent',p2pp3,...
    'Title','Recorder',...
    'FontUnit','Pixel','Fontsize',12,...
    'BackgroundColor',defaultBackground,...
    'Visible','on',...
    'Units','pixels',...
    'Position',[0 subPanelHeight-240 mainPanelWidth 240]);
...
p2p11 = uipanel('Tag','parameter_laser_panel',...
    'parent',p2pp3,...
    'Title','Laser',...
    'FontUnit','Pixel','Fontsize',12,...
    'BackgroundColor',defaultBackground,...
    'Visible','on',...
    'Units','pixels',...
    'Position',[mainPanelWidth+10 subPanelHeight-280 mainPanelWidth 280]);
...
% Controls for p4
p4p1 = uipanel('Tag','tools_panel_metafileread_panel',...
    'parent',p4,...
    'Title','Metafile read',...
    'FontUnit','Pixel','Fontsize',12,...
    'BackgroundColor',defaultBackground,...
...
uicontrol('Tag','tools_panel_metafileread_file_text',...
    'Style','text',...
    'parent',p4p1,...
    'FontUnit','Pixel','Fontsize',12,...
    'HorizontalAlignment','Right',...
...
uicontrol('Tag','tools_panel_metafileread_format_edit',...
    'Style','edit',...
    'parent',p4p1,...
    'FontUnit','Pixel','Fontsize',12,...
    'HorizontalAlignment','Left',...
    ...
    'Visible','on',...
    'Units','pixels',...
    'String','Name of metafile',...
    'Position',[70 70 mainPanelWidth-110 25]...
    );
uicontrol('Tag','tools_panel_metafileread_file_pushbutton',...
    'Style','pushbutton',...
	'Parent', p4p1, ...
    'BackgroundColor',defaultBackground,...
    'FontUnit','Pixel','Fontsize',12,...
    ...
    'Enable','on',...
    'Callback',{@pushbutton_Callback,'metafilereadfilename'}...
    );
uicontrol('Tag','tools_panel_metafileread_format_text',...
    'Style','text',...
    'parent',p4p1,...
    'FontUnit','Pixel','Fontsize',12,...
    'HorizontalAlignment','Right',...
...
uicontrol('Tag','tools_panel_metafileread_format_popupmenu',...
    'Style','popupmenu',...
    'Parent',p4p1,...
    'BackgroundColor',defaultBackground,...
    'FontUnit','Pixel','Fontsize',12,...
    ...
    'String','Liesmich (FR, new)|Liesmich (FR, old)|fsc2 metafile (B)|trEPR metafile'...
    );
uicontrol('Tag','tools_panel_metafileread_apply_pushbutton',...
    'Style','pushbutton',...
	'Parent', p4p1, ...
    'BackgroundColor',defaultBackground,...
    'FontUnit','Pixel','Fontsize',12,...
    ...
    'Enable','on',...
    'Callback',{@pushbutton_Callback,'metafilereadapply'}...
    );
uicontrol('Tag','tools_panel_metafileread_load_pushbutton',...
    'Style','pushbutton',...
	'Parent', p4p1, ...
    'BackgroundColor',defaultBackground,...
    'FontUnit','Pixel','Fontsize',12,...
    ...
    'Enable','on',...
    'Callback',{@pushbutton_Callback,'metafilereadload'}...
    );


p4p2 = uipanel('Tag','tools_panel_metafilewrite_panel',...
    'parent',p4,...
    'Title','Metafile write',...
    'FontUnit','Pixel','Fontsize',12,...
    'BackgroundColor',defaultBackground,...
    'Visible','on',...
    'Units','pixels',...
    'Position',[10+mainPanelWidth+10 mainPanelHeight-120 mainPanelWidth 120]);
uicontrol('Tag','tools_panel_metafilewrite_file_text',...
    'Style','text',...
    'parent',p4p2,...
    'FontUnit','Pixel','Fontsize',12,...
    'HorizontalAlignment','Right',...
...
uicontrol('Tag','tools_panel_metafilewrite_format_edit',...
    'Style','edit',...
    'parent',p4p2,...
    'FontUnit','Pixel','Fontsize',12,...
    'HorizontalAlignment','Left',...
...
uicontrol('Tag','tools_panel_metafilewrite_file_pushbutton',...
    'Style','pushbutton',...
	'Parent', p4p2, ...
    'BackgroundColor',defaultBackground,...
    'FontUnit','Pixel','Fontsize',12,...
...
uicontrol('Tag','tools_panel_metafilewrite_format_text',...
    'Style','text',...
    'parent',p4p2,...
    'FontUnit','Pixel','Fontsize',12,...
    'HorizontalAlignment','Right',...
...
uicontrol('Tag','tools_panel_metafilewrite_format_popupmenu',...
    'Style','popupmenu',...
    'Parent',p4p2,...
    'BackgroundColor',defaultBackground,...
    'FontUnit','Pixel','Fontsize',12,...
...
uicontrol('Tag','tools_panel_metafilewrite_preview_pushbutton',...
    'Style','pushbutton',...
	'Parent', p4p2, ...
    'BackgroundColor',defaultBackground,...
    'FontUnit','Pixel','Fontsize',12,...
    ...
    'pos',[70 10 (mainPanelWidth-80)/2 30],...
    'Enable','on',...
    'Callback',{@pushbutton_Callback,'metafilereadpreview'}...
    );
uicontrol('Tag','tools_panel_metafilewrite_save_pushbutton',...
    'Style','pushbutton',...
	'Parent', p4p2, ...
    'BackgroundColor',defaultBackground,...
    'FontUnit','Pixel','Fontsize',12,...
    ...
    'pos',[70+(mainPanelWidth-80)/2 10 (mainPanelWidth-80)/2 30],...
    'Enable','on',...
    'Callback',{@pushbutton_Callback,'metafilereadsave'}...
    );

p4p3 = uipanel('Tag','tools_panel_metafiledisplay_panel',...
    'parent',p4,...
    'Title','Metafile display',...
    'FontUnit','Pixel','Fontsize',12,...
    'BackgroundColor',defaultBackground,...
    'Visible','on',...
    'Units','pixels',...
    'Position',[10 mainPanelHeight-330 mainPanelWidth*2+10 200]);
uicontrol('Tag','tools_panel_metafiledisplay_edit',...
    'Style','edit',...
    'parent',p4p3,...
    'FontUnit','Pixel','Fontsize',12,...
    'FontName','FixedWidth',...
...
function updateParameterPanel()
    try
        ...
        matchingParameter = {...
            ...
            'parameter_panel_datestart_edit','yyyy-mm-dd','date',''; ...
            'parameter_panel_dateend_edit','yyyy-mm-dd','date',''; ...
            ...
            'parameter_panel_temperaturecontroller_edit','0','temperature.model',''; ...
