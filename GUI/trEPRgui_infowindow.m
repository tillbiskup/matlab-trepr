...
p2p2 = uipanel('Tag','parameter_transient_panel',...
    'parent',p2,...
    'Title','Transient',...
    'FontUnit','Pixel','Fontsize',12,...
    'BackgroundColor',defaultBackground,...
...
p2p3 = uipanel('Tag','parameter_recorder_panel',...
    'parent',p2,...
    'Title','Recorder',...
    'FontUnit','Pixel','Fontsize',12,...
    'BackgroundColor',defaultBackground,...
...
uicontrol('Tag','parameter_panel_fieldcalibration_text',...
    'Style','text',...
    'Parent',p2p4,...
    'BackgroundColor',defaultBackground,...
    'FontUnit','Pixel','Fontsize',12,...
...
uicontrol('Tag','parameter_panel_fieldcalibration_edit',...
    'Style','edit',...
    'Parent',p2p4,...
    'BackgroundColor',editableBackground,...
    'FontUnit','Pixel','Fontsize',12,...
    ...
    'String','0',...
    'Callback',{@parameter_edit_Callback,'fieldcalibration'}...
    );

p2p5 = uipanel('Tag','parameter_bridge_panel',...
    'parent',p2,...
    'Title','Bridge',...
    'FontUnit','Pixel','Fontsize',12,...
    'BackgroundColor',defaultBackground,...
...
uicontrol('Tag','parameter_panel_mwcalibration_edit',...
    'Style','edit',...
    'Parent',p2p5,...
    'BackgroundColor',editableBackground,...
    'FontUnit','Pixel','Fontsize',12,...
    ...
    'Position',[110 40 mainPanelWidth-120 25],...
    'String','0',...
    'Callback',{@parameter_edit_Callback,'mwcalibration'}...
    );
...
p2p6 = uipanel('Tag','parameter_laser_panel',...
    'parent',p2,...
    'Title','Laser',...
    'FontUnit','Pixel','Fontsize',12,...
    'BackgroundColor',defaultBackground,...
...
function updateParameterPanel()
    try
        ...
        if isempty(ad.data)
            ...
            set(gh.parameter_panel_fieldcalibration_edit,'String','0');
            ...
            set(gh.parameter_panel_mwcalibration_edit,'String','N/A');
