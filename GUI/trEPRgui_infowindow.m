...
uicontrol('Tag','characteristics_panel_soi_linecoloursample_text',...
    ...
    'String','',...
    'Enable','Inactive',...
    'ButtonDownFcn',{@colourPalette_Callback,'soiLineColour'}...
    );
...
uicontrol('Tag','characteristics_panel_soi_markeredgecoloursample_text',...
    ...
    'String','',...
    'Enable','Inactive',...
    'ButtonDownFcn',{@colourPalette_Callback,'soiMarkerEdgeColour'}...
    );
...
uicontrol('Tag','characteristics_panel_soi_markerfacecoloursample_text',...
    ...
    'String','',...
    'Enable','Inactive',...
    'ButtonDownFcn',{@colourPalette_Callback,'soiMarkerFaceColour'}...
    );
...
uicontrol('Tag','characteristics_panel_doi_linecoloursample_text',...
    ...
    'String','',...
    'Enable','Inactive',...
    'ButtonDownFcn',{@colourPalette_Callback,'doiLineColour'}...
    );
...
uicontrol('Tag','characteristics_panel_doi_markeredgecoloursample_text',...
    ...
    'String','',...
    'Enable','Inactive',...
    'ButtonDownFcn',{@colourPalette_Callback,'doiMarkerEdgeColour'}...
    );
...
uicontrol('Tag','characteristics_panel_doi_markerfacecoloursample_text',...
    ...
    'String','',...
    'Enable','Inactive',...
    'ButtonDownFcn',{@colourPalette_Callback,'doiMarkerFaceColour'}...
    );
        ...
        switch lower(action)
            case 'soilinecolour'
                ad.data{ad.control.spectra.active...
                    ...
                    ad.info.characteristics.type).idx).line.color = ...
                    uisetcolor(...
                    colorstr2rgb(ad.data{ad.control.spectra.active...
                    }.characteristics.(ad.info.characteristics.type)(...
                    ad.info.characteristics.(...
                    ad.info.characteristics.type).idx).line.color),...
                    'Set line colour');
        ...
        switch lower(action)
            case 'characteristicslabel'
                ad.data{ad.control.spectra.active...
                    ...
                    ad.info.characteristics.(...
                    ad.info.characteristics.type).idx).label = ...
                    get(source,'String');
            case 'characteristicscomment'
                ad.data{ad.control.spectra.active...
                    }.characteristics.(ad.info.characteristics.type)(...
                    ad.info.characteristics.(...
                    ad.info.characteristics.type).idx).comment = ...
                    get(source,'String');
            otherwise
                trEPRoptionUnknown(action);
                return;
