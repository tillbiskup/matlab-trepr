...
trEPRadd2status('Info GUI window opened.','info');
    ...
    try
        ...
        switch value
            ...
            otherwise
                % fallback
                trEPRadd2status(...
                    [mfilename ' : general_edit_Callback() : '...
                    'Unknown field "' value '".'],'warning')
                return;
        end
...
function guiClose()
    try
        ...
        trEPRadd2status('Closing Info GUI.','info');
...
function switchPanel(panelName)
    try
        ...
        switch panelName
            ...
            otherwise
                trEPRadd2status(...
                    [mfilename ' : switchPanel(): '...
                    'Unknown panel "' panelName '".'],'warning');
                return;
        end
    catch exception
        try
...
function switchParameterPanel(panelName)
    try
        ...
        switch lower(panelName)
            ...
            otherwise
                trEPRadd2status(...
                    [mfilename ' : switchParameterPanel(): '...
                    'Unknown panel "' panelName '".'],'warning');
                return;
        end
    catch exception
...
function updateParameterPanel()
    try
        ...
        matchingParameter = {...
            ...
            'parameter_panel_amplificationunit_edit','MHz','bridge.amplification.unit',''; ...
            ...
            'parameter_panel_backgroundfieldunit_edit','0','background.field.unit',''; ...
            'parameter_panel_backgroundoccurrence_edit','0','background.occurrence',''; ...
            'parameter_panel_backgroundpolarisation_edit','us','background.polarisation',''; ...
            % Recorder panel
