...
if ishandle(mainGUIHandle)
    ...
    guiPosition = [mainGUIPosition(1)+10,mainGUIPosition(2)+10,800,670];
else
    guiPosition = [30,50,800,670];
end
...
tb1 = uicontrol('Tag','display_togglebutton',...
    ...
    'FontUnit','Pixel','Fontsize',12,...
    'String','Display',...
    'TooltipString','Seect dataset and review display settings',...
...
tb2 = uicontrol('Tag','parameters_togglebutton',...
    ...
    'FontUnit','Pixel','Fontsize',12,...
    'String','Parameters',...
    'TooltipString','Set parameters for baseline correction (BLC)',...
...
tb3 = uicontrol('Tag','correction_togglebutton',...
    ...
    'FontUnit','Pixel','Fontsize',12,...
    'String','Correction',...
    'TooltipString','Perform actual baseline correction (BLC)',...
...
if (mainGuiWindow)
    ...
    if (isfield(admain,'data') ~= 0)
        ...
        for m = 1:length(ad.data)
            ad.data{m}.blc.fit = ad.configuration.fit;
            [y,~] = size(ad.data{m}.data);
            for l = 1:length(ad.data{m}.blc.fit.point)
                ad.data{m}.blc.fit.point(l).position = round(y/2);
            end
        end
        setappdata(hMainFigure,'data',ad.data);
...
function fitarea_panel_slider_Callback(source,~,area)
    try
        ...
        switch area
            case 'left'
                ad.data{ad.control.data.active}.blc.fit.area.left = ...
                    int16(get(source,'Value'));
            case 'right'
                ad.data{ad.control.data.active}.blc.fit.area.right = ...
                    int16(get(source,'Value'));
            case 'back'
                ad.data{ad.control.data.active}.blc.fit.area.back = ...
                    int16(get(source,'Value'));
        end
        ...
        switch point
            case 1
                if get(source,'Value')
                    ...
                    ad.data{ad.control.data.active}.blc.fit.point(1).active = true;
                else
                    ...
                    ad.data{ad.control.data.active}.blc.fit.point(1).active = false;
                end
            case 2
                if get(source,'Value')
                    ...
                    ad.data{ad.control.data.active}.blc.fit.point(2).active = true;
                else
                    ...
                    ad.data{ad.control.data.active}.blc.fit.point(2).active = false;
                end
        end
...
function addpoints_panel_slider_Callback(source,~,point)
    try
        ...
        ad.data{ad.control.data.active}.blc.fit.point(point).position = ...
            int16(get(source,'value'));
    ...
    try
        ...
        switch action
            ...
            case 'showMaximum'
                ...
                ad.data{ad.control.data.active}.display.position.x = ximax;
                ad.data{ad.control.data.active}.display.position.y = yimax;
...
function updateAxes()
    ...
    try
        ...
        backarea = ad.data{ad.control.data.active}.blc.fit.area.back;
        leftarea = ad.data{ad.control.data.active}.blc.fit.area.left;
        rightarea = ad.data{ad.control.data.active}.blc.fit.area.right;
        ...
        switch ad.control.axis.displayType
            case '2D plot'
                ...
                hold on;
                % Plot 2D data
                imagesc(ad.data{ad.control.data.active}.data,'Parent',gh.axis1);
            ...
            case '1D along x'
                ...
                plot(gh.axis1,...
                    ...
                    'k-');
                set(gh.axis1,'XLim',[1 x]);
                z = [ min(min(ad.data{ad.control.data.active}.data)) ...
        ...
        meanData = mean(ad.data{ad.control.data.active}.data(...
            :,x-ad.data{ad.control.data.active}.blc.fit.area.back:x...
            ),2);
        % Including this (redundand) line here seems to prevent
        % Matlab from crashing due to stupid errors (plot: vectors
        % must be of same length) when being too fast with the
        ...
        for k=1:length(ad.data{ad.control.data.active}.blc.fit.point)
            if (ad.data{ad.control.data.active}.blc.fit.point(k).active)
                line(...
                    [ ad.data{ad.control.data.active}.blc.fit.point(k).position ...
                    ad.data{ad.control.data.active}.blc.fit.point(k).position ],...
                    [ ZLim(1) ZLim(2) ],...
                    'Color','r',...
                    'Parent',gh.axis2);
...
function updateSpectra()
    try
        ...
        set(gh.fitarea_panel_back_slider,'Min',1,'Max',x,...
            'Value',ad.data{ad.control.data.active}.blc.fit.area.back,...
            'SliderStep',[1/(x-1) 10/(x-1)],...
            'Enable','on');
        set(gh.fitarea_panel_left_slider,'Min',1,'Max',y,...
            'Value',ad.data{ad.control.data.active}.blc.fit.area.left,...
            'SliderStep',[1/(y-1) 10/(y-1)],...
            'Enable','on');
        set(gh.fitarea_panel_right_slider,'Min',1,'Max',y,...
            'Value',ad.data{ad.control.data.active}.blc.fit.area.right,...
            'SliderStep',[1/(y-1) 10/(y-1)],...
            'Enable','on');
        set(gh.addpoints_panel_pt1_slider,'Min',1,'Max',y,...
            'Value',ad.data{ad.control.data.active}.blc.fit.point(1).position,...
            'SliderStep',[1/(y-1) 10/(y-1)]...
            );
        set(gh.addpoints_panel_pt2_slider,'Min',1,'Max',y,...
            'Value',ad.data{ad.control.data.active}.blc.fit.point(2).position,...
            'SliderStep',[1/(y-1) 10/(y-1)]...
            );
    catch exception
        trEPRexceptionHandling(exception)
...
function update_position_display()
    ...
    try
        ...
        set(gh.sliderposition_y_index_edit,...
            'String',...
            num2str(ad.data{ad.control.data.active}.display.position.y));
        % Set unit
        [y,~] = size(ad.data{ad.control.data.active}.data);
        y = linspace(1,y,y);
        ...
        set(gh.sliderposition_y_unit_edit,...
            'String',...
            num2str(y(ad.data{ad.control.data.active}.display.position.y)));
        
        % Set position in time edit boxes
        set(gh.sliderposition_x_index_edit,...
            'String',...
            num2str(ad.data{ad.control.data.active}.display.position.x));
        % Set unit
        [~,x] = size(ad.data{ad.control.data.active}.data);
        x = linspace(1,x,x);
        if (isfield(ad.data{ad.control.data.active},'axes') ...
        ...
        set(gh.sliderposition_x_unit_edit,...
            'String',...
            num2str(x(ad.data{ad.control.data.active}.display.position.x)));
...
function update_fitarea_display()
    ...
    try
        ...
        set(gh.fitarea_panel_left_edit,...
            'String',...
            num2str(ad.data{ad.control.data.active}.blc.fit.area.left));
        set(gh.fitarea_panel_right_edit,...
            'String',...
            num2str(ad.data{ad.control.data.active}.blc.fit.area.right));
        set(gh.fitarea_panel_back_edit,...
            'String',...
            num2str(ad.data{ad.control.data.active}.blc.fit.area.back));
        % Set slider
...
function update_addpoint_display()
    try
        ...
        set(gh.addpoints_panel_pt1_edit,...
            'String',...
            num2str(ad.data{ad.control.data.active}.blc.fit.point(1).position));
        set(gh.addpoints_panel_pt2_edit,...
            'String',...
            num2str(ad.data{ad.control.data.active}.blc.fit.point(2).position));
        % Set slider
        set(gh.addpoints_panel_pt1_slider,'Value',...
            ad.data{ad.control.data.active}.blc.fit.point(1).position);
        set(gh.addpoints_panel_pt2_slider,'Value',...
            ad.data{ad.control.data.active}.blc.fit.point(2).position);
    catch exception
        trEPRexceptionHandling(exception)
    end 
end
    ...
    try
        ...
        switch action
            ...
            case 'resetPreview'
                ...
                return;
            case 'apply'
                ad.data{ad.control.data.active}.data = trEPRBGC(...
                    ad.data{ad.control.data.active}.data, ...
                    'numBGprofiles',...
                    [ad.blc.regions.left ad.blc.regions.right] ...
                    );
                % Add record to history
                ad.data{ad.control.data.active}.history{end+1} = struct(...
                    'date',datestr(now,31),...
                    'method','trEPRBGC',...
                    'system',struct(...
                ...
                ad.blc.spectra = ...
                    [ ad.blc.spectra ad.control.data.active ];
                ad.blc.corrFun.values = [];
                setappdata(mainWindow,'data',ad.data);
                setappdata(mainWindow,'blc',ad.blc);
                updateAxes();
                return;
            case 'reset'
                ad.blc.spectra(ad.blc.spectra==ad.control.data.active) = [];
                ad.blc.corrFun.values = [];
                ad.data{ad.control.data.active}.data = ...
                    ad.origdata{ad.control.data.active}.data;
                setappdata(mainWindow,'data',ad.data);
                setappdata(mainWindow,'blc',ad.blc);
                updateAxes();
                return;
