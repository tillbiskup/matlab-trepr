...
uicontrol('Tag','parameters_togglebutton',...
    'Style','Toggle',...
	'Parent', hButtonGroup, ...
    'BackgroundColor',defaultBackground,...
    'FontUnit','Pixel','Fontsize',12,...
...
uicontrol('Tag','correction_togglebutton',...
    'Style','Toggle',...
	'Parent', hButtonGroup, ...
    'BackgroundColor',defaultBackground,...
    'FontUnit','Pixel','Fontsize',12,...
    ...
    switch ad.control.axis.displayType
        case '1D along x'
            set(gh.position_slider,'Value',...
                ad.data{ad.control.data.active}.display.position.data(2),...
                'Max',size(ad.data{ad.control.data.active}.data,1));
        case '1D along y'
            set(gh.position_slider,'Value',...
                ad.data{ad.control.data.active}.display.position.data(1),...
                'Max',size(ad.data{ad.control.data.active}.data,2));
    end
catch exception
    trEPRexceptionHandling(exception)
end
...
try
    ...
    switch action
        case 'applyPreview'
            switch correctionMethod
                case 'First n time traces'
                    y = size(ad.data{ad.control.data.active}.data,1);
