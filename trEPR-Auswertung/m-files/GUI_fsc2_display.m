...
function GUI_fsc2_display (data, field_params, time_params, titlestring)
	...
	set([f,ha,hslider,htext_slider_value,h_togglebutton_comp,h_togglebutton_disp,htext_title,htext_slider_measure],'Units','normalized');
