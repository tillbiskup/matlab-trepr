function varargout = trEPR_GUI_BLC(varargin)
% TREPR_GUI_BLC M-file for trEPR_GUI_BLC.fig
%      TREPR_GUI_BLC, by itself, creates a new TREPR_GUI_BLC or raises the existing
%      singleton*.
%
%      H = TREPR_GUI_BLC returns the handle to a new TREPR_GUI_BLC or the handle to
%      the existing singleton*.
%
%      TREPR_GUI_BLC('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in TREPR_GUI_BLC.M with the given input arguments.
%
%      TREPR_GUI_BLC('Property','Value',...) creates a new TREPR_GUI_BLC or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before trEPR_GUI_BLC_OpeningFunction gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to trEPR_GUI_BLC_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help trEPR_GUI_BLC
...
gui_State = struct('gui_Name',       mfilename, ...
                   ...
                   'gui_OpeningFcn', @trEPR_GUI_BLC_OpeningFcn, ...
                   'gui_OutputFcn',  @trEPR_GUI_BLC_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before trEPR_GUI_BLC is made visible.
function trEPR_GUI_BLC_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to trEPR_GUI_BLC (see VARARGIN)

% Choose default command line output for trEPR_GUI_BLC
...
% UIWAIT makes trEPR_GUI_BLC wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = trEPR_GUI_BLC_OutputFcn(hObject, eventdata, handles) 
