...
%	$Revision: 760 $
% MODIFICATION DATE
%	$Date: 2008-11-06 17:12:09 +0000 (Do, 06 Nov 2008) $
% KEYWORDS
...
function GUI_fsc2_display
	...
	fprintf('\nFUNCTION CALL: $Id: GUI_fsc2_display.m 760 2008-11-06 17:12:09Z till $\n\n');
...
%	efmh3 = uimenu(fmh,'Label','Save as...');
	...
	function revision = revision
		revision = strrep(strrep('$Revision: 760 $','Revision: ',''),'$','');
