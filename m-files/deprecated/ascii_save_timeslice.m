...
% 
%****f* file_handling.ascii_save_data/ascii_save_timeslice.m
%
% AUTHOR
...
%
% EXAMPLE
%	If you want to save the time slice timeslice with the field parameters fp and
%	the time parameters tp measured at the frequency freq to the file named 'ts.dat'
%	just typein:
%
%		ascii_save_timeslice ( 'ts.dat', timeslice, fp, tp, freq )
%
% SOURCE

function ascii_save_timeslice ( filename, timeslice, field_params, time_params, varargin )

	fprintf ( '\nFUNCTION CALL: $Id: ascii_save_timeslice.m 253 2006-06-20 13:55:09Z web8 $\n' );
	...
	if nargout ~= 0
		...
		error('\n\tThe function is called with the wrong number (%i) of output arguments.\n\tPlease use "help ascii_save_timeslice" to get help.',nargout);
	...
	fprintf(fid, '%s This file has been written by the routine $Id: ascii_save_timeslice.m 253 2006-06-20 13:55:09Z web8 $\n', comment_char);
	fprintf(fid, '%s\n', comment_char);
