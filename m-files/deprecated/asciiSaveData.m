...
function [ varargout ] = asciiSaveData ( varargin )
	...
	fprintf('%% FUNCTION CALL: $Id: asciiSaveData.m 931 2009-02-19 19:56:07Z till $\n');
...
%	end
	...
	fprintf(fid, '%s This file has been written by the routine $Id: asciiSaveData.m 931 2009-02-19 19:56:07Z till $\n', comment_char);
	fprintf(fid, '%s\n', comment_char);
