...
%	$Revision: 616 $
% MODIFICATION DATE
%	$Date: 2008-04-28 10:43:09 +0100 (Mo, 28 Apr 2008) $
% KEYWORDS
...
%
%       spemanAscii2trEPR2Ddata ( 'Samplecczc' );
%
...
function [ varargout ] = spemanAscii2trEPR2Ddata ( filebasename, varargin )
	...
	fprintf('\nFUNCTION CALL: $Id: spemanAscii2trEPR2Ddata.m 616 2008-04-28 09:43:09Z till $\n\n');
...
%	timeSlice = load(tempFirstFileName);
    ...
    timeSlice = readDataOfSpemanAsciiFile (tempFirstFileName);
	...
	if ( noSlices > 1 )
		...
		for j = 2:noSlices
            ...
            if ( exist(tempLastFileName) == 2 )
                ...
                timeSlice = readDataOfSpemanAsciiFile (tempLastFileName);
...
function [ data ] = readDataOfSpemanAsciiFile ( filename );
...
function [ B0, frequency ] = readLeadingCommentOfSpemanAsciiFile ( filename );
	...
	% read the leading commentary of the speman ASCII file line by line
