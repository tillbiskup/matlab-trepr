...
%	$Revision: 530 $
% MODIFICATION DATE
%	$Date: 2008-02-25 11:00:15 +0000 (Mo, 25 Feb 2008) $
% KEYWORDS
...
%
%	In case the input file is of the wrong format there is a warning (display of that
%	warning depends on the local settings) and the global variable "status" is set to
%	a value <> 0. To test this:
%
%		global status;
%		status
%
%	Within a program, after calling ascii_read_2Dspectrum, query the status variable
...
function [ spectrum, field_params, time_params, frequency ] = ascii_read_2Dspectrum ( filename )
	...
	fprintf('\n%% FUNCTION CALL: $Id: ascii_read_2Dspectrum.m 530 2008-02-25 11:00:15Z till $\n%% \n');
