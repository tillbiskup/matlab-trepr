...
%
%****f* interactive_programs.trEPR/analyze_timeslice.m
%
% AUTHOR
...
%	$Revision: 303 $
% MODIFICATION DATE
%	$Date: 2006-09-01 16:36:08 +0100 (Fr, 01 Sep 2006) $
% KEYWORDS
...
fprintf( '\nThis is the file $Id: analyze_timeslices.m 303 2006-09-01 15:36:08Z web8 $\n' );
...
fprintf( '\nThis is the file $RCSfile$,\n\t$Revision: 303 $ from $Date: 2006-09-01 16:36:08 +0100 (Fr, 01 Sep 2006) $\n' );
...
while exit_main_loop > 0			% main while loop
	...
	legend('measured time slice','mono-exponential fit','bi-exponential fit');
...
%	savefittedfunction_filename = sprintf('%s-fittedfunction.dat',outputfile_basename);
	...
	summary(exit_main_loop,:) = [field_position/10, tmax, t1e(1), dt1e(1)];
