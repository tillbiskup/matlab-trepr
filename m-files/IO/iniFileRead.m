...
%
%	To read these parameters with the iniFileRead function, use
%
%		metadata = iniFileRead ( 'sample.dsc' );
%
...
%
%	That will make the function iniFileRead use the respective
...
%
%		metadata = iniFileRead ( 'sample2.conf', params );
%
...
function [ metadata ] = iniFileRead ( filename, varargin )
	...
	if ( nargin < 1 ) || ( nargin > 2 )
		...
		error('\n\tThe function is called with the wrong number (%i) of input arguments.\n\tPlease use "help iniFileRead" to get help.',nargin);

	end

	if ( nargout ~= 1 )

		error('\n\tThe function is called with the wrong number (%i) of output arguments.\n\tPlease use "help iniFileRead" to get help.',nargout);
