...
%	$Revision: 754 $
% MODIFICATION DATE
%	$Date: 2008-10-21 08:39:44 +0100 (Di, 21 Okt 2008) $
% KEYWORDS
%	transient EPR, SVD
%
% SYNOPSIS
...
function [ varargout ] = svd_analysis ( filename, varargin )
	...
	fprintf ( '\n%% FUNCTION CALL: $Id: svd_analysis.m 754 2008-10-21 07:39:44Z till $\n' );
...
%		end
	...
	if ( strcmp(outputFormat,'LaTeX') )
		...
		LaTeXheaderParams.authorString = sprintf('%s\\thanks{%s "%s"}','Till Biskup','till.biskup@physik.fu-berlin.de, file generated with',strrep('$ $Id: svd_analysis.m 754 2008-10-21 07:39:44Z till $ $','_','\_')); 
